...
echo("<th rowspan=2> Kode </th>")         	;$mwd2='4 readonly';
echo("<th rowspan=1 colspan=2> Barcode </th>")  ;$mwd34='4 readonly';
echo("<th rowspan=2> Nama </th>")         	;$mwd5='35 readonly';
...
<table border=1 cellpadding=0 cellspacing=0 bgcolor='white' style='width:50vw;border-collapse:collapse'>
");
