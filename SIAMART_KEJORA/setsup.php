...
/*	
$ada=execute(" SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE table_schema='esae1797_kejora' and TABLE_NAME = 'setsup' AND COLUMN_NAME = 'isppn' ")->column_name;
...
?>	
	...
	FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='esae1797_kejora' and TABLE_NAME='setsup' 
