...
<form id="fform" name="fform">
	<table style="color: white; font-family: Arial" width="100%">
		...
		<tr>
			<td colspan="2">Kasir : <input id="mkasir" size="5" type="text"><input id="mlkasir" type="button" value="F5"><input size=10 id="mkasirnama" readonly type="text"> 
			Pelanggan : <input id="mlgnid" size="5" type="text"><input id="mllgn" type="button" value="F5"><input size=10  id="mlgnnama" readonly type="text"> 
			Grup Stok : <input id="mgrpid" size="5" type="text"><input id="mlgrpid" type="button" value="F5"><input size=10 id="mgrpnama" readonly type="text"> 
			Jenis : <select id="mtk">
		...
		<tr>
			<td colspan="2">Suplier : <input id="msupid" size="5" type="text"><input id="mlsup" type="button" value="F5"><input id="msupnama" readonly type="text">
			</td>
		</tr>
	</table>
</form>
