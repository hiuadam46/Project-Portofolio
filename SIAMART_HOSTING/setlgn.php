...
$Pcs2(document).ready(function()
{
	...
	$Pcs2("#tcetak").click(function()
	{
		window.open("isilaporan.php?mLapo=mSetup&mtabelnya=setlgn&isprint=YY&detitle=Master Pelanggan<br>")
	})
});
</script>
...
FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='esae1797_pancurmas' and TABLE_NAME='setlgn'
and COLUMN_COMMENT<>''
