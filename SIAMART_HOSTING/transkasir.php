...
$Pcs2(document).ready(function()
{
	...
	$Pcs2("#fform").keydown(function()
	{
		...
		if (mmv==116 && (mmid.substr(0,2)=='12' || mmid.substr(0,2)=='32') )
		{
			...
			if (hakedit==1)
			{
				query1="select left(a.stoid, 10) K, left(a.barcode, 15) Barc, left(a.stonama, 48) Nama, left(format(a.hrgjual"+mha+"/if("+msatuan+"=1, 1, isi), 0), 12) rightHarga, 'L001' QSALDO, stoid from setstok a "
				query2=" where true "
			}
			else
			{
				query1="select left(a.stoid, 10) K, left(a.barcode, 10) Barc, left(a.stonama, 48) Nama, left(format(a.hrgjual"+mha+"/if("+msatuan+"=1, 1, isi), 0), 12) rightHarga from setstok a "
				query2=" where true "
			}
			query1="select left(a.stoid, 10) K, left(a.barcode, 10) Barc, left(a.stonama, 48) Nama, left(format(a.hrgjual"+mha+"/if("+msatuan+"=1, 1, isi), 0), 12) rightHarga, 'L001' QSALDO, stoid from setstok a "
			query2=" where true "
		...
		if(mmv==112&& (mmid.substr(0,2)=='12' || mmid.substr(0,2)=='32')){
			mwo=window.open("transkasir.php");
			mwo.focus()
		}
		if(mmv==113){
		...
		if(mmv==114&& (mmid.substr(0,2)=='12' || mmid.substr(0,2)=='32')){
			arahsatuan(1)
		...
		if(mmv==115&& (mmid.substr(0,2)=='12' || mmid.substr(0,2)=='32')){
			arahsatuan(2)
		...
		if(mmv==117&& (mmid.substr(0,2)=='12' || mmid.substr(0,2)=='32')){
			$Pcs2('#btndiskon').click()
		}
		if(mmv==118&& (mmid.substr(0,2)=='12' || mmid.substr(0,2)=='32')){
			
		}
		if(mmv==119&& (mmid.substr(0,2)=='12' || mmid.substr(0,2)=='32')){
			arahharga(2,true)
		...
		if(mmv==120&& (mmid.substr(0,2)=='12' || mmid.substr(0,2)=='32')){
			arahharga(3,true)
...
function baru(mgdn)
{
	...
	$Pcs2("#lblwalk").html("Toko PANCURMAS Motor Siap Melayani Anda")
...
<form id="fform" name="fform">
	<table border="0" style="border-collapse: ; color: white; font-family: Arial; font-weight: bold" width="100%">
		...
		<tr>
			<td align="center" colspan="1" rowspan="1" style="width: 100%; vertical-align: middle">
			<label id="lblwalk" style="font-size: 18pt">Toko PANCURMAS Motor Siap Melayani Anda</label> </td>
			<td align="right" colspan="2" valign="bottom">
			<label id="divtot" style="font-size:24pt">0</label></td>
		</tr>
		<tr>
			...
			<td align="right" style="background-color:orange" valign="top">
				<table id="mtab1" border="0" style="font-size: 10pt; background-color: #A52A2A; width:300px" width="100%">
					...
					<tr style="height:20px">
						<td id="board" align="center" style="width:10%;font-weight: bold; background-color: #FFC0CB;" valign="top">
						<span style='width:2020px'>w</span>
						</td>
					</tr>
					<tr>
					...
					<tr style="display: none">
						...
						<input id="mdiskon" onblur="lostfokes(this)" onfocus="fokes(this)" onkeyup="rumus2()" size="10" style="text-align: right; font-weight: bold; font-size: 13pt" type="text"></td>
					</tr>
					<tr align='right'>
						<td>Jumlah
						<input id="mjumlah" onkeyup="rumus2()" readonly size="7" style="text-align: right; font-weight: bold; font-size: 24pt" type="text"></td>
					</tr>
					<tr align='right'>
						<td>EDC
						<input id="medc" onkeyup="rumus2()" size="7" style="text-align: right; font-weight: bold; font-size: 24pt" type="text"></td>
					</tr>
					<tr>
					...
					<tr style="display: none">
						<td align="right">Ref
						<input id="mref1" size="10" style="text-align: right; font-weight: bold; font-size: 13pt" type="text"></td>
					</tr>
					<tr style="display: none">
						<td align="right">
						<input id="mref2" size="10" style="text-align: right; font-weight: bold; font-size: 13pt" type="text"></td>
					</tr>
					<tr align='right'>
						<td>Bayar
						<input id="mbayar" onblur="lostfokes(this)" onfocus="fokes(this)" onkeyup="rumus2()" size="7" style="text-align: right; font-weight: bold; font-size: 24pt" type="text"></td>
					</tr>
					<tr>
						<td><hr></td>
					</tr>
					<tr align='right'>
						<td style='width:120%'>Kembali
						<input id="mkembali" onblur="lostfokes(this)" onfocus="fokes(this)" size="7" style="text-align: right; font-weight: bold; font-size: 24pt" type="text"></td>
					</tr>
					<tr>
						<td align="center"><hr>
					...
					<tr>
						<td align=right>Total Poin
						<input id="mtpoin" readonly="readonly" size="8" style="text-align: right; font-weight: bold; font-size: 13pt" type="text"></td>
					</tr>
					<tr>
						<td align=right>Saldo Poin
						<input id="mtjpoin" readonly="readonly" size="8" style="text-align: right; font-weight: bold; font-size: 13pt" type="text"></td>
					</tr>
					<tr>
