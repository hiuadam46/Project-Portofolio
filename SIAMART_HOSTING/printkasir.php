...
function buatnota()
{
	...
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Toko PANCURMAS Motor'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Desa Harjokuncaran no 1 RT 9. RW3, kec Sumbermanjing wetan.'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Telp 0812-2922-5497'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'================================'+'</td></tr>'
