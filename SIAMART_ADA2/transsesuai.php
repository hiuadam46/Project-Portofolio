...
<head>
    ...
    <script type="text/javascript">
	  ...
	  var dialogisopen=false;
		...
		query1="select left(a.stoid,10) stoid,left(a.barcode,10) Barc,left(a.stonama,48) Nama,left(format(a.hrgbeli,0),15) rightHarga,'"+$Pcs2("#mlokid1").val()+"' QSALDO from setstok a "
		query2=" where true "
