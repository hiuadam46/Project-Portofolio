...
<div id="mmnu" style="text-align: right">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			UD. ANGEL</label></b><br>
			<span id="subtitle" style="color: white; font-family: Verdana">Jl Bromo No 10 Wlingi Blitar</span></td>
			<td valign="top">
...
('PENJUALAN','topmenu','Penjualan','','','','1','1'),
	...
	('TRANSJUAL','','Penjualan Gudang','transjual.php','','PENJUALAN','1','1'),
...
('LAPORAN','topmenu','Laporan','','','','1','1'),
	('LAPKASIR','','Laporan Penjualan Kasir','','','LAPORAN','1','1'),
	    ('LAPJUALKASIR','','Laporan Penjualan Kasir','lapjualkasir.php','','LAPKASIR','1','1'),
	    ('LAPKASIR','','Laporan Penjualan per Kasir','lapjualkasirperkasir.php','','LAPKASIR','1','1'),
	    ('LAPKASIR','','Laporan Penjualan Per Nota','lapjualperiodik.php','','LAPKASIR','1','1'),
	    ('LAPKASIR','','Laporan Penjualan Detail ','lapjual3.php','','LAPKASIR','1','1'),
	    ('LAPKASIR','','Laporan Poin Pelanggan','lappoin.php','','LAPKASIR','1','1'),
	
	('LAPJUAL','','Laporan Penjualan Gudang','','','LAPORAN','1','1'),
	   ...
	   ('LAPJUAL','','Laporan Penjualan Periodik','lapjualperiodik2.php','','LAPJUAL','1','1'),	
