...
$Pcs2(document).ready(function()
{
	...
	execajaxas("alter table transbeli1 add lokid varchar(10) default 'L002' ")
	baru()
	...
	$Pcs2("#fform").keydown(function()
	{
		...
		{
			query1="select left(a.stoid, 10) stoid, left(a.barcode, 10) Barc, left(a.stonama, 48) Nama, left(format(a.hrgbeli, 0), 15) rightHarga, '"+idLokasi+"' QSALDO from setstok a "
			query2=" where true "
