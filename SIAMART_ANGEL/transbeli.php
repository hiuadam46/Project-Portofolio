...
$Pcs2(document).ready(function()
{
	...
	$Pcs2("#fform").keydown(function()
	{
		...
		{
			query1="select left(a.stoid, 10) stoid, left(a.barcode, 10) Barc, left(a.stonama, 45) Nama, left(format(a.hrgbeli, 0), 12) rightHarga, '"+idLokasi+"' QSALDO from setstok a "
			query2=" where true "
