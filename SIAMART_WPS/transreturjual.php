...
<form id="fform" name="fform">
	<table border="0" style="color: white; font-family: Arial; font-weight: bold" width="85%">
		...
		<tr>
			<td>pelanggan </td>
			<td colspan="5">: <input id="mlgnid" size="5" type="text"><input id="lookmlgnid" type="button" value="F5"><input id="mlgnnama" disabled size="45" type="text"></td>
		</tr>
		<tr>
			<td>Atas Nota</td>
			<td>: <input id="mjualid" size="10" type="text"><input id="lookjual" type="button" value="F5"> 
			Tgl : <input id="mjualtgl" disabled size="10" type="text"> </td>
		</tr>
		<tr>
			<td>Catatan </td>
			<td colspan="5">: <input id="mket" size="100" type="text"></td>
		</tr>
	</table>
