...
function buatnota()
{
	...
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'&nbsp;'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'========================================'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'CV. WPS'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Jl.Ciliwung 15 Blitar'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Telp. 0342-802423'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'========================================'+'</td></tr>'
	mjadd=mjadd+'</table>'
