...
<meta http-equiv="content-type" content="text/html; charset=ISO-8859-1">
  ...
  $Pcs2(document).ready(function(){
	...
	$Pcs2("#btnsimpan").click(function() {
		...
		msql="delete from bkbesar where bpid='"+msupid+"' and trans='SA' and rekid='"+mrekid+"' "
		...
		success : function(data){
			...
			msqql2="values('"+mrekid+"','"+msupid+"','"+mtglx+"','"+mnid+"',"+msaldo+",'SA','SA : "+mket+"')"
...
?>
	...
	<tr>
	<td>Suplier </td><td colspan=5>: <input type=text  size=5 id='msupid' value=<?php echo $msupid; ?>><input type=button id=lookmsupid value='F5'><input type=text id=msupnama size=45 disabled>
	</td>
	</tr>

	<tr>
	<td>Rekening </td><td colspan=5>: <?php combobox("select rekid misi,concat(rekid,'-',reknama) mtampil from setrek where nrcid in ('200','201') order by rekid","mrekid"); ?>
	</td>
	</tr>
	</table>
