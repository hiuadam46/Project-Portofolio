...
function buatlaporan(ngeprint, excel)
{
	...
	if (!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src", "isilaporan.php?mLapo=mlapdistribusi&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mkarid="+sal+"&mstoid="+$Pcs2("#mstoid").val()+"&msupid="+$Pcs2("#msupid").val())
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapdistribusi&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mkarid="+sal+"&mstoid="+$Pcs2("#mstoid").val()+"&msupid="+$Pcs2("#msupid").val())
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapdistribusi&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&msales="+$Pcs2("#mkarid").val())
	}
}
</script>
<script type="text/javascript">
	...
	<div>
		<table style="position: relative; text-align: left; color: white; font-family: Arial" width="100%">
			...
			<tr>
				...
				Sales : <?php combobox("select '' misi,'' mtampil union select karid misi,concat(karid,'-',karnama) mtampil from setkaryawan order by misi","mkarid"); ?>
				</td>
			</tr>
		</table>
	</div>
