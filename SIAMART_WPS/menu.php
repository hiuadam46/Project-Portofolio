...
<div id="mmnu" style="text-align: right">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			CV. WPS</label></b><br>
			<span id="subtitle" style="color: white; font-family: Verdana">Jl.Ciliwung 15 Blitar</span></td>
			<td valign="top">
...
('MASTER','topmenu','Master','','','','1','1'),
	...
	('SETSTOK','','Harga Barang','setstok.php','','MASTER','6','1'),
...
('STOK','topmenu','Stok','','','','1','1'),
	('TRANSPRODUKSI','','Produksi','transproduksi.php','','STOK','1','1'),
...
('LAPORAN','topmenu','Laporan','','','','1','1'),
	('LAPJUALKASIR','','Laporan Penjualan','','','LAPORAN','1','1'),
	     ('LAPJUALKASIR','','Laporan Penjualan Kasir','lapjualkasir.php','','LAPJUALKASIR','1','1'),
	     ('LAPJUALKASIRPERKASIR','','Laporan Penjualan per Kasir','lapjualkasirperkasir.php','','LAPJUALKASIR','1','1'),
		 ('LAPJUALPERIODIK','','Laporan Penjualan Per Nota','lapjualpernota.php','','LAPJUALKASIR','1','1'),
	     ('LAPJUAL3','','Laporan Penjualan Detail ','lapjual3.php','','LAPJUALKASIR','1','1'),
	     ('LAPDISTRIBUSI','','Laporan Distribusi Barang','lapdistribusi.php','','LAPJUALKASIR','1','1'),
	...
	('LAPPRODUKSI','','Laporan Produksi','lapproduksi.php','','LAPORAN','1','1'),
	('LAPMUTASI','','Laporan Mutasi Gudang','lapmutasigudang.php','','LAPORAN','1','1'),
