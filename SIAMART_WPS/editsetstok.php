...
<tr><td align=left>Hrg. Jual D &nbsp</td> <td colspan=3> : <input type=text size=10 name='mhrgjual4' id='mhrgjual4' $msty2  value='<?php echo number_format($mstok[hrgjual4],0,'.',',') ?>'  style='text-align:right'></td></tr>
