...
<?php
$msql="
SELECT COLUMN_NAME kolom, DATA_TYPE tipe, NUMERIC_PRECISION panjang1, CHARACTER_MAXIMUM_LENGTH
panjang2, COLUMN_COMMENT koment
FROM information_schema.COLUMNS
WHERE TABLE_SCHEMA='siamart_wps_data' and TABLE_NAME='setlgn' and COLUMN_COMMENT<>''
...
while ($row=mysql_fetch_assoc($rww))
{
	...
	if (($row[kolom])=='telp2')
	{
		echo ": <select id='mtelp2' $mtpe> <option value='PKP'>PKP</option> <option value='Non PKP'>Non PKP</option> </select>";
	}
	else
	{
