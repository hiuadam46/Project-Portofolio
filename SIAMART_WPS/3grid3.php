...
$query="select a.sales,b.karnama
from transkasir1 a left join setkaryawan b on a.kasir=b.karid 
...
while ($rows=mysql_fetch_assoc($rrw))
	{
		...
		echo "	
		<td><input type='text_$mnom' $midname size=$mwd2
		value='".$rows[kasir]."' $nstt onblur=ambilsales(this)></td>
		";
...
// $query="select a.nid,a.tgl,concat(a.sales,' - ',b.karnama) sales,
//concat(a.lgnid,' - ',c.lgnnama,', ',c.alamat) pelanggan,
...
// where concat(a.lgnid,c.alamat,c.lgnnama,a.nid) like '%$mcari%' and c.rute like '%$msupid%' and a.nid not in $mrekap and a.sales='$msales'
// and a.jumlah-ifnull(d.kredit,000000000000)>0
// order by a.nid ";


// $query= "select a.nid,a.tgl,concat(a.kasir,' - ',b.karnama) sales, concat(a.lgnid,' - ',
// c.lgnnama,' - ',c.alamat) pelanggan, FORMAT(a.jumlah,0) jumlah, 
// FORMAT((a.bayar+a.edc+e.kredit+ifnull(d.retur,0)),0) terbayar, 
// FORMAT(a.jumlah-ifnull((a.bayar+edc+e.kredit+ifnull(d.retur,0)),000000000000),0) sisa 
// from transkasir1 a left join (select jualid nid,sum(total) retur 
// from transreturjual1 group by jualid) d on a.nid=d.nid 
...
// where concat(a.lgnid,c.alamat,c.lgnnama,a.nid) like '%$mcari%'
// and c.rute like '%$msupid%' and a.nid not in $mrekap 
// and (a.jumlah-ifnull((a.bayar+edc+e.kredit+ifnull(d.retur,0)),000000000000))>0 order by a.nid ";

$query= "select a.nid,a.tgl,concat(a.kasir,' - ',b.karnama) sales, concat(a.lgnid,' - ',
c.lgnnama,' - ',c.alamat) pelanggan, FORMAT(a.jumlah,0) jumlah, 
FORMAT((ifnull(a.bayar,0)+ifnull(a.edc,0)+ifnull(e.kredit,0)),0) terbayar, 
FORMAT(a.jumlah-ifnull((ifnull(a.bayar,0)+ifnull(a.edc,0)+ifnull(e.kredit,0)),000000000000),0) sisa ,
a.bayar, e.kredit as pelunasan
from transkasir1 a 
left join (select nid2,bpid,sum(kredit) kredit 
from bkbesar where rekid='10210' group by nid2,bpid) e on a.nid=e.nid2 and a.lgnid=e.bpid
left join setkaryawan b on a.kasir=b.karid 
left join setlgn c on a.lgnid=c.lgnid 
where concat(a.lgnid,c.alamat,c.lgnnama,a.nid) like '%$mcari%'
and c.rute like '%$msupid%' and a.nid not in $mrekap 
and (a.jumlah-ifnull((ifnull(a.bayar,0)+ifnull(a.edc,0)+ifnull(e.kredit,0)),000000000000))>0 order by a.nid ";
...
$query="select a.nid,a.tgl,concat(a.kasir,' - ',b.karnama) sales,
concat(a.lgnid,' - ',c.lgnnama,', ',c.alamat) pelanggan,
FORMAT(a.jumlah,0) jumlah,FORMAT((ifnull(a.bayar,0)+ifnull(a.edc,0)+ifnull(e.kredit,0)),0) terbayar,
FORMAT(a.jumlah-ifnull((ifnull(a.bayar,0)+ifnull(a.edc,0)+ifnull(e.kredit,0)),000000000000),0) sisa 
from transkasir1 a 
left join (select nid2,bpid,sum(ifnull(kredit,0)) kredit 
from bkbesar where rekid='10210' group by nid2,bpid) e on a.nid=e.nid2 and a.lgnid=e.bpid
