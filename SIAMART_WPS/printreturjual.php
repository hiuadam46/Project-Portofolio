...
htt=''
     ...
     htt=htt+'<tr><td><font size=3>"CV. WPS"</font></td><td align=right><font size=3>FAKTUR RETUR PENJUALAN</font></td></tr>'
     htt=htt+'<tr><td><font size=2>Jl. Dr. Wahidin 51 Blitar</font></td><td align=right><font size=3>Tanggal : '+opener.$Pcs2("#mtgl").val()+'</font></td></tr>'
     ...
     htt=htt+'<tr><td><b><font size=3>'+mpel.alamat+'</font></td><td align=left> Faktur No.: '+opener.$Pcs2("#mnid").val()+'</td></tr>'
     htt=htt+'<tr><td><b><font size=3>               </font></td><td align=left> Dipotong No.: '+opener.$Pcs2("#mjualid").val()+'</td></tr>'
     htt=htt+'<tr><td><b><font size=3>               </font></td><td align=left> Tgl.: '+opener.$Pcs2("#mjualtgl").val()+'</td></tr>'
     htt=htt+'</table>'     
...
if (mstop){break;}     
	...
	htt=htt+"<tr><td> <table width=93% border=0 cellspacing=0><tr><td align=right width=30%>"+mq1+'</td><td>&nbsp;'+ms1+"</td><td align=right width=30%>&nbsp;&nbsp;"+mq2+'</td><td>&nbsp;'+ms2+"</td></tr></table> </td><td>&nbsp;</td><td>&nbsp;&nbsp;"+opener.$Pcs2("#13_"+abg).val()+"</td><td align=right>"+tra(toval(opener.$Pcs2("#18_"+abg).val())-toval(opener.$Pcs2("#19_"+abg).val()))+"&nbsp;</td><td align=right>"+opener.$Pcs2("#20_"+abg).val()+"&nbsp;</td></tr>"
