...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			//$Pcs2("#framelap").attr("src", "isilaporan.php?mLapo=mlapjual3_baru&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
			$Pcs2("#framelap").attr("src", "isilaporan.php?mLapo=mlapjual3_baru&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mgrpid="+mgrpid);
		}
		else
		{
			//window.open("isilaporan.php?mLapo=mlapjual3_baru&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
			window.open("isilaporan.php?mLapo=mlapjual3_baru&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mgrpid="+mgrpid);
		}
	}
	else
	{
		//window.open("isilaporan.php?mLapo=mlapjual3_baru&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
		window.open("isilaporan.php?mLapo=mlapjual3_baru&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mgrpid="+mgrpid);
	}
