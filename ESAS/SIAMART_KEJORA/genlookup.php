...
///awal functions
	...
	window.addEventListener("keydown", function(e) {//ARAH ATAS
	...
	window.addEventListener("keydown", function(e) {//ARAH BAWAH
	...
	window.addEventListener("keydown", function(e) {//ARAH KIRI
