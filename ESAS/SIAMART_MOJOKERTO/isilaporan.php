...
FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='siamart_mojokerto_data' and TABLE_NAME='$mtabelnya'
";
...
{
$msql="SELECT COLUMN_NAME kolom,DATA_TYPE tipe,NUMERIC_PRECISION panjang1,CHARACTER_MAXIMUM_LENGTH panjang2,COLUMN_COMMENT koment
FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='siamart_mojokerto_data' and TABLE_NAME='$mtabelnya' and COLUMN_NAME in ($mkol)
";
}
...
<td align=right>".number_format(($msx->jmlhrg-$wrr->hpp)-$totalhppsales,0,'.',',')."</td>
</tr>
";
