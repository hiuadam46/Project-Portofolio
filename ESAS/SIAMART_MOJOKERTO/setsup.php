...
<html><head>
	...
	for (var mii=1;mii<30;mii++)
	{
		...
		if (mtp=='fieldna2')
		{
			...
			fsetstok.misppn.value=data[isppn];
			fsetstok.msupnama.focus();fsetstok.msupnama.select();
	    });
...
/*	
$ada=execute(" SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE table_schema='siamart_mojokerto_data' and TABLE_NAME = 'setsup' AND COLUMN_NAME = 'isppn' ")->column_name;
...
?>	
	...
	FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='siamart_mojokerto_data' and TABLE_NAME='setsup' 
	and COLUMN_COMMENT<>'' and COLUMN_NAME in ('supid','supnama','alamat','telp','tempo','kontak','keterangan','isppn') 
