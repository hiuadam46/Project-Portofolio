...
<tr><td align=left>Hrg. Batas Sales&nbsp</td> <td colspan=3> : <input type=text size=10 name='mhrgjual' id='mhrgjual' $msty2  value='<?php echo number_format($mstok[hrgjual],0,'.',',') ?>' style='text-align:right'></td></tr>
