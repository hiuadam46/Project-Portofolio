...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapbeli2&mtg1="+mtgl1+"&mtg2="+mtgl2+"&msupid="+asd+"&mgrpid="+mgrpid);
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapbeli2&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mgrpid="+mgrpid);
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapbeli2&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mgrpid="+mgrpid);
	}
}
</script>
<script type="text/javascript">
	...
	<div>
		<table style="position: relative; text-align: left; color: white; font-family: Arial" width="100%">
			...
			<tr>
				...
				<input id="msupid" size="8" type="text"><input id="mlsup" type="button" value="F5"><input id="msupnama" readonly type="text"><font face='Arial' color='white' >&nbsp;
				Grup Stok :
			<input type=text id=mgrpid size=8>
			<input type='button' id=mlgrpid value='F5'>
