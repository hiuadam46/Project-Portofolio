...
function buatnota()
{
	...
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'ADA SENTOSA STATIONERY'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Maospati Magetan'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Telp 085105711157'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'=================================='+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>No.'+abc.$Pcs2("#mnid").val()+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tgl. '+abc.$Pcs2("#mtgl").val()+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>Pel.'+abc.$Pcs2("#mlgnid").val()+' '+abc.$Pcs2("#mlgnnama").val()+'&nbsp;&nbsp;&nbsp;&nbsp; Jam &nbsp;:&nbsp;'+abc.$Pcs2("#mjam").val()+'</td></tr>'
	...
	for (gg=1;gg<101;gg++)
	{
		...
		mjadd=mjadd+'<tr height=0><td align=left>&nbsp;&nbsp;&nbsp;'+padl(mqty,'&nbsp;',6)+'</td> <td>&nbsp;&nbsp;&nbsp;'+padl(msatuan,'&nbsp;&nbsp;',5)+'</td><td>X</td> <td>'+padl(mhrgsat,'&nbsp;',9)+'</td><td>=</td><td align=right width=10%>'+padl(mjmlhrg,'&nbsp;',12)+'</td></tr>'
	}
	mjadd=mjadd+'</table>'
	...
	mjadd=mjadd+'<tr height=0><td colspan=1>'+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;SALDO POIN </td><td align=right width=10%>'+Math.floor(padl(abc.$Pcs2("#mtjpoin").val(),' ',11))+'</td></tr>'
	//}
	//else
	//{
