...
<table>
<tr><td><font color=white>Kode user  </td><td> : <input type=text size='20' name=mid id=mid value='<?php echo $mstok[id] ?>' maxlength='20' $msty></td></tr>
<tr><td><font color=white>Nama user  </td><td> : <input type=text name=mnama id=mnama size=50 maxlength='200' value='<?php echo $mstok[nama] ?>' title='Isikan Nama user'></td></tr>
<tr><td><font color=white>Password  </td><td> : <input type=text name=mpass id=mpass size=50 maxlength='200' value='<?php echo $mstok[password] ?>' title='Isikan password user'></td></tr>
<tr><td><font color=white>Edit/Hapus  </td><td> : <input type=checkbox name=medit id=medit <?php echo $medit ?>></td></tr>
</td></tr>
<tr><td><font color=white>Akses Menu  </td><td> :</td></tr>
</table>
