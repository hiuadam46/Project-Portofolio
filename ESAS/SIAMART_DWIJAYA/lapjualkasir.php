...
?>	
	...
	Grup Stok : <input type=text id=mgrpid size=8><input type='button' id=mlgrpid value='F5'><input type=text id=mgrpnama readonly>
	Jenis : <select id='mtk'> <option value='Semua'>Semua</option> <option value='Tunai'>Tunai</option> <option value='Kredit'>Kredit</option> </select>
	Urut : <select id='mur'> <option value='nama'>Nama Stok</option> <option value='qty'>Qty</option> <option value='rp'>Rupiah</option>  </select>
	</td>
	</tr>	
