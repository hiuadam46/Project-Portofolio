...
function buatlaporan(ngeprint, excel)
{
	...
	if (!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src", "isilaporan.php?mLapo=mlapdistribusi2&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mkarid="+sal+"&mstoid="+$Pcs2("#mstoid").val()+"&msupid="+$Pcs2("#msupid").val())
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapdistribusi2&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mkarid="+sal+"&mstoid="+$Pcs2("#mstoid").val()+"&msupid="+$Pcs2("#msupid").val())
		}
	}
	else
	{
