...
echo("<th colspan=4> Saldo </th>");$mwd4567='6';
echo("<th colspan=4> Order </th>");$mwd891011='6';
echo("<th rowspan=2> Harga </th>");$mwd12='6 readonly';
echo("<th rowspan=2> Jumlah </th>");$mwd13='10 readonly';
echo("</tr>");

echo("<tr>");

echo("<th colspan=2> Qty </th>");$mwd4='4 readonly';
$mwd5='4 readonly';
echo("<th colspan=2> Unit </th>");$mwd6='4 readonly';
$mwd7='4 readonly';
...
FORMAT(hrgsat,0) hrgsat,FORMAT(diskonp,2) diskon,FORMAT(a.jmlhrg,0) jmlhrg
from transbeli2 a right join setstok b on a.stoid=b.stoid
