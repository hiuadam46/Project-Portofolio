...
<head>
    ...
    <script type="text/javascript">
	  ...
	  var dialogisopen=false;
		...
		if (mnn=='2' && ( mmv==116 || ( mmv==13 && event.element(event).value=='' ) ))
		{
   ...
   $Pcs2("#kotakdialog2").dialog({
	...
	$Pcs2("#btnprint").click(function() {
		xxw=window.open('printmutasi.php?mnid='+mnid,'aa',('alwaysraised=yes,scrollbars=no,resizable=no,width=450,height=400,left=600,top=10'));
		xxw.focus()
	})
...
?>
	...
	<td> :
	<?php
	combobox("select lokid misi,concat(loknama,' - ',lokid) mtampil from setlok order by urutan","mlokid1");
	?>
	</td>
	...
	<hr>
	<input type='button' id='btnsimpan' value='Simpan'></input> <input type=button id='btnbaru' value='Baru'></input> <input type=button id='btnhapus' value='Hapus'></input> <input type=button id='btnprint' value='Print'> <input type=button id='btnkeluar' value='Keluar'></input>
	</form>
