...
<head>
    ...
    <script type="text/javascript">
	  ...
	  var dialogisopen=false;
		...
		$Pcs2("#kotakdialog2").dialog('option', 'title', 'Lookup Kloter');
	...
	for (ma=1;ma<100;ma++)
		{
			...
			if (abcd=='D')
			{
			msqql="insert into bkbesar(rekid ,bpid,bpid2 ,tgl,nid,kredit,trans,ket,nid2) "
			msqql = msqql + " values('"+mrekid+"','"+mbpid+"','"+mlokid+"',"+mtgl+",'"+mnid+"',"+mjumlah+",'transnonkas','"+mket+"','O')"
			execajaxa(msqql)
			}

			if (abcd=='K')
			{
			msqql="insert into bkbesar(rekid ,bpid ,bpid2,tgl,nid,debet,trans,ket,nid2) "
			msqql = msqql + " values('"+mrekid+"','"+mbpid+"','"+mlokid+"',"+mtgl+",'"+mnid+"',"+mjumlah+",'transnonkas','"+mket+"','O','"+mlokid+"')"
			execajaxa(msqql)
			}
	...
	for (ma=200;ma<300;ma++)
		{
			...
			{
			msqql="insert into bkbesar(rekid ,bpid,bpid2 ,tgl,nid,debet,trans,ket,nid2) "
			msqql = msqql + "values('"+mrekid+"','"+mbpid+"','"+mlokid+"',"+mtgl+",'"+mnid+"',"+mjumlah+",'transnonkas','"+mket+"','I')"
			execajaxa(msqql)
			}

			if (abcd=='K')
			{
			msqql="insert into bkbesar(rekid ,bpid ,tgl,nid,kredit,trans,ket,nid2) "
			msqql = msqql + "values('"+mrekid+"','"+mbpid+"','"+mlokid+"',"+mtgl+",'"+mnid+"',"+mjumlah+",'transnonkas','"+mket+"','I')"
			execajaxa(msqql)
			}
...
?>
	...
	<tr>
	<td>Lokasi </td> 
			<td> : <input id="mlokid" size="5" type="text" >
				<input id="looklok" type="button" value="F5">
				<input id="mloknama" disabled size="25" type="text"> 
		</td>
		</tr>
