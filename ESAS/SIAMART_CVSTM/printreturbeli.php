...
<meta http-equiv="content-type" content="text/html; charset=ISO-8859-1">
    ...
    var $Pcs2 = jQuery.noConflict();
     ...
     mpel=taptabel('setsup','alamat',"supid='"+opener.$Pcs2("#mlgnid").val()+"'")
     
////
htt=''

     htt=htt+"<table border=0 cellspacing=0 width='1220px'>"  
     htt=htt+'<tr><td><font size=3>"CV. SUMBER TANI MANDIRI"</font></td><td align=right><font size=3>FAKTUR RETUR PEMBELIAN</font></td></tr>'
     htt=htt+'<tr><td><font size=2>Jl Jombang Dpn Zipur 5 Babatg</font></td><td align=right><font size=3>Tanggal : '+opener.$Pcs2("#mtgl").val()+'</font></td></tr>'
     htt=htt+'<tr><td>&nbsp;</td><td align=right>&nbsp;</td></tr>'
     htt=htt+'<tr><td><b><font size=3>Kepada : '+opener.$Pcs2("#msupnama").val()+'</font></td><td align=left>&nbsp;</td></tr>'
     htt=htt+'<tr><td><b><font size=3>'+mpel.alamat+'</font></td><td align=right><font size=3>  Faktur No.: '+opener.$Pcs2("#mnid").val()+'</font></td></tr>'
     htt=htt+'<tr><td><b><font size=3>               </font></td><td align=right><font size=3>Dipotong No.: '+opener.$Pcs2("#mbeliid").val()+'</font></td></tr>'
     htt=htt+'<tr><td><b><font size=3>               </font></td><td align=right><font size=3>Tgl.: '+opener.$Pcs2("#mbelitgl").val()+'</font></td></tr>'
     htt=htt+'</table>'     
