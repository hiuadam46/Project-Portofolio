...
<meta http-equiv="content-type" content="text/html; charset=ISO-8859-1">
  ...
  $Pcs2(document).ready(function(){
	...
	$Pcs2("#fform").keydown(function() {	
		...
		{
		query1="select left(a.stoid,10) stoid,left(a.barcode,10) Barc,left(a.stonama,43) Nama,left(format(a.hrgbeli,0),12) rightHarga,'L001' QSALDO from setstok a "
		query2=" where isppn like '"+misp+"%' "
	...
	$Pcs2("#msupid").blur(function() {
		...
		datas=taptabel("setsup","supid,isppn,plafon,supnama,DATE_ADD(str_to_date('"+$Pcs2("#mtgl").val()+"','%d-%c-%Y'), INTERVAL tempo DAY) jt","supid='"+this.value+"'")
...
///awal functions
	...
	function ambilstok(theid)
	{
		...
		mstok=taptabel("setstok","stoid,stonama,satuan1,satuan2,satuan3,format(hrgbeli,0) hrgbeli,isi"," stoid='"+misi+"' or barcode='"+misi+"' or barcode2='"+misi+"' and isppn like '"+misp+"%' ")
