...
function buatnota()
{
	...
	mjadd=mjadd+'<table width=100% cellspacing=0 cellpadding=0 border=0>'
			...
			mjadd=mjadd+'<tr height=0><td colspan=2>'+'&nbsp;'
			mjadd=mjadd+'<tr height=0><td colspan=2>'+'========================================'+'</td></tr>'
			mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'CV. SUMBER TANI MANDIRI'+'</td></tr>'
			mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Jl Raya Sukoanyar Wajak '+'</td></tr>'
