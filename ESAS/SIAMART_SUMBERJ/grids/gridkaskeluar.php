...
<td bgcolor=lightblue align=center><b>BP[F5]</td> 
...
<td><input type='text_$mnom' id='5_$mnom' name='5_$mnom' class='rcell' size=12 value='".$rows[bpid]."' disabled $msty  onblur=ambilbp(this)></td>
<td><input type='text' id='6_$mnom' name='6_$mnom' class='rcell'  size=20 value='".$rows[bpnama]."' disabled $msty></td>
</tr>
...
$query="
select a.rekid,b.reknama,FORMAT(a.debet,0) jumlah,a.bpid,concat(ifnull(c.supnama,''),ifnull(d.karnama,''),ifnull(e.lgnnama,'')) bpnama 
from bkbesar a  
...
where a.nid='$mnnid' and debet<>0 order by rekid
";
	...
	while ($rows=mysql_fetch_assoc($rrw))
	{
		...
		<td><input type='text_$mnom' id='5_$mnom' name='5_$mnom' class='rcell' size=12 value='".$rows[bpid]."' $msty  onblur=ambilbp(this)></td>
		<td><input type='text' id='6_$mnom' name='6_$mnom' class='rcell'  size=20 value='".$rows[bpnama]."' disabled $msty></td>
		</tr>";
		$mnom++;
	}
	...
	for ($mii=$mnom;$mii<100;$mii++)
	{
		...
		<td><input type='text_$mnom' id='5_$mnom' name='5_$mnom' class='rcell' size=12 value='' $msty' onblur=ambilbp(this)></td>
		<td><input type='text' id='6_$mnom' name='6_$mnom' class='rcell'  size=20 value='' disabled $msty'></td>
		</tr>";
		$mnom++;
	}
	$mjum=$mnom-1;
