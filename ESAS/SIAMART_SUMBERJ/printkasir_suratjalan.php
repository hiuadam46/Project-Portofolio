...
<div>
	<table cellpadding="0" cellspacing="0" style="width: 100%">
		...
		<tr>
			...
			<label id="Label1" style="display: ">TB. SUMBER JAYA MAKMUR 2</label></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="5"><label id="Label2" style="display: ">Jl Raya Ranggeh 12 Pasuruan</label></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="5"><label id="Label3" style="display: ">Telp :</label></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>Telp.</td>
	...
	<table cellpadding="0" cellspacing="0" style="width: 100%;height:103mm">
		<thead>
			<tr style="border-style: solid; border-width: 1px">
				<th style="width: 45px; <?php echo borders(1,0,1,1,2) ?>">NO.</th>
...
?>
	...
	<table cellpadding="0" cellspacing="0" style="width: 100%">
		<tr>
			<td colspan="2">1. Dengan menanda tangani form ini berarti barang telah diterima dengan baik</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="4">2. Komplain tidak dapat diterima setelah mobil pengiriman meninggalkan lokasi</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;Segala bentuk kekurangan atau kerusakan bukan lagi menjadi tanggungjawab kami </td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="3">3. Untuk Granit dan keramik harap membuka sendiri isi masing-masing kardus</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
			<td>4. Komplain retak/pecah tidak berlaku untuk KW-3</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
