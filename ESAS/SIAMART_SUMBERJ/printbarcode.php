<?php
	...
	echo "
	<center>
	<table border=0 cellpadding=0 cellspacing=11 style='position:absolute;top:-13;left:5'>
	";
	echo "<tr>";
	echo "<td valign=top>";
	...
	echo "<tr><td width=80 align=left valign=top><b><font size=1 face=verdana>".substr($bbe->stonama,0,23)."</td></tr>";
