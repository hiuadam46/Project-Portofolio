...
<div id="mmnu" style="text-align: right" width=200%>
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<td style="width: 1%">&nbsp;</td>
			<td align="left" style="width: 20%" valign="top"><b>
			<label style="color: white; font-family: Verdana; font-size: 14pt; text-decoration: underline">
			TB. SUMBER JAYA MAKMUR 2</label></b><br>
			<span id="subtitle" style="color: white; font-family: Verdana">Jl Raya Ranggeh 12 Pasuruan</span></td>
			<td valign="top">
...
('MASTER','topmenu','Master','','','','1','1'),
	...
	('SETPRINTB','','Print Label/Barcode','setprintbarcode.php','','MASTER','6','1'),
	('SETUPDTSTOK','','Update Harga Stok','setupdatestok.php','','MASTER','6','1'),
...
('LAPORAN','topmenu','Laporan','','','','1','1'),
	...
	('LAPJUAL2','','Laporan Penjualan Detail','lapjual2.php','','LAPORAN','1','1'),
	...
	('LAPSTOK','','Stok','','','LAPORAN','1','1'),
		...
		('LAPPNSTOK','','Laporan Penyesuaian Stok','lappnstok.php','','LAPSTOK','1','1'),
