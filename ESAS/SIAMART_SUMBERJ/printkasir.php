...
function buatnota()
{
	...
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'&nbsp;'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'========================================'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'TB. SUMBER JAYA MAKMUR 2'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Jl Raya Ranggeh 12 Pasuruan'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Telp 0343-441242'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'========================================'+'</td></tr>'
	mjadd=mjadd+'</table>'
