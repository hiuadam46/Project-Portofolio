...
<?php
$query117=executerow('
select a.*, b.stonama, b.satuan1, b.satuan2, b.satuanb1, b.satuanc1
from transjual2 a
...
<div>
	<table cellpadding="0" cellspacing="0" style="width: 100%">
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td style="font-weight: bold; font-size: 14pt; text-align: center">BUKTI 
			TITIPAN</td>
			<td>&nbsp;</td>
			<td>Kepada</td>
			<td>:</td>
		...
		<tr>
			<td colspan="5"><label id="Label2" style="font-weight:">Jln Raya No 312 C Babat Lamongan</label></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="5"><label id="Label3" style="font-weight:">Telp 081554638742</label></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>Telp.</td>
	...
	<table cellpadding="0" cellspacing="0" style="width: 100%;height:103mm">
		<thead>
			<tr style="border-style: solid; border-width: 1px">
				...
				<th colspan="6" style="<?php echo borders(1,0,1,1,2) ?>">QTY. JUAL</th>
				<th colspan="2" style="<?php echo borders(1,0,1,1,2) ?>">EXTRA</th>
...
?>
	...
	<table cellpadding="0" cellspacing="0" style="width: 100%">
		<tr>
			<td colspan="2">Sebelum ada pelunasan semua barang adalah titipan</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
