...
<?php
$query117=executerow('
select a.*, format(a.qty, 0) qty, b.stonama, b.satuan1, b.satuan2
from transkasir2 a
...
<div>
	<table cellpadding="0" cellspacing="0" style="width: 100%">
		<tr>
			...
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td colspan="6" style="text-align: right;display:none">Halaman&nbsp;<?php echo $j+1 ?> dari&nbsp;<?php echo $jumlahhal ?> halaman</td>
		</tr>
		<tr>
			<td colspan="5" style="font-weight: bold; font-size: 14pt">
			<label id="Label1" style="display: ">TOKO TIMUR</label></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="5"><label id="Label2" style="display: ">Jl Bromo 1 Wlingi Blitar</label></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="5"><label id="Label3" style="display: ">Telp. 0342-691055</label></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>Telp.</td>
	...
	<table cellpadding="0" cellspacing="0" style="width: 100%;height:39mm">
		<thead>
			<tr style="border-style: solid; border-width: 1px;height:7mm">
...
?>
		<tfoot>
			<tr style="height:7mm">
				...
				<td style="<?php echo borders(0,0,1,0,2) ?>">&nbsp;</td>
				<td style="<?php echo borders(0,0,1,0,2) ?>">&nbsp;</td>
				<td colspan="6" style="font-weight: bold; text-align: right; <?php echo borders(1,0,1,0,2) ?>" rowspan="2">
				Total :</td>
				<td colspan="2" style="font-weight: bold; text-align: right; <?php echo borders(0,1,1,0,2) ?>" rowspan="2">
