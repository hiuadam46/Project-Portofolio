...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlaplunaspiutang&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mrute="+mrute);
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlaplunaspiutang&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mrute="+mrute+"&isprint=YY");
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlaplunaspiutang&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mrute="+mrute+"&isprint=YY");
	}
}
</script>
<script type="text/javascript">
...
<form id="fform" name="fform">
	<div>
		<table style="text-align: left; color: white; font-family: Arial" width="100%">
			<tr>
