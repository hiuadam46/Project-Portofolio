...
echo("<th rowspan=2> Kode<br>[F5][F6]</th>");$mwd2='8';
echo("<th rowspan=2> Uraian </th>");$mwd3='40 readonly';
echo("<th colspan=4> Qty Beli </th>");$mwd4567='6';
echo("<th colspan=4> Extra </th>");$mwd891011='6';
echo("<th rowspan=2> Harga </th>");$mwd12='6';
echo("<th rowspan=2> Dis<br>% </th>");$mwd13='3';
echo("<th rowspan=2> Jumlah </th>");$mwd14='8 readonly';
echo("</tr>");
...
echo("<th colspan=2> Qty </th>");$mwd8='4';
$mwd9='4 readonly';
echo("<th  colspan=2> Unit </th>");$mwd10='4';
$mwd11='4 readonly';
...
while ($rows=mysql_fetch_assoc($rrw))
	{
		...
		$mjrow=$mjrow+1;$midname="id='$mjrow".'_'."$mnom'  name='$mjrow".'_'."$mnom'";		
		echo "	
		<td><input type='text' $midname size=$mwd11
		value='".$nng[satuan2]."' $nstt ></td>
		";
	...
	<tr>
	<td bgcolor='white' rowspan=5 colspan=10 align=center>&nbsp;<font color=red><span id='spanket'></span></td>
	<td bgcolor='white' colspan=3 align=right>Total&nbsp;&nbsp;</td>
	<td bgcolor='white'><input size=$mwd14 type='text'  $nstt2 readonly id='mtotal'></td>
	</tr>

	<tr>
	<td  bgcolor='white' colspan=3 align=right>Penyesuaian&nbsp;&nbsp;</td>
