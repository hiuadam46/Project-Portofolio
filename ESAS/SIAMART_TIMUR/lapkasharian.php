...
$Pcs2(document).ready(function()
{
	...
	buatlaporan();
	$Pcs2("#headertrans").html("<b>Kas/Bank Harian")
...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapkashar&mtg1="+mtgl1+"&mtg2="+mtgl2);
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapkashar&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY");
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapkashar&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY");
	}
}
</script>
<script type="text/javascript">
