...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapbeli2&mtg1="+mtgl1+"&mtg2="+mtgl2+"&msupid="+asd+"&mstoid="+mstoid);
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapbeli2&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+mstoid);
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapbeli2&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+mstoid);
	}
}
</script>
<script type="text/javascript">
