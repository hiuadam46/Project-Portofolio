...
<title>Pembelian Jt Tempo</title>
...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapbelijt&mtg1="+mtgl1+"&mtg2="+mtgl2+"&msupid="+asd+"&mstoid="+mstoid);
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapbelijt&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+mstoid);
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapbelijt&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+mstoid);
	}
}
</script>
<script type="text/javascript">
		...
		<table style="position: relative; text-align: left; color: white; font-family: Arial" width="100%">
			...
			<tr>
				...
				<input id="msupnama" readonly type="text"> 
					<!--Stok :
					<input id="mstoid" size="8" type="text">
					<input id="mlookstok" type="button" value="F5">
					<input id="mstonama" readonly type="text">-->
				</td>
			</tr>
		</table>
	</div>
