...
$rowx=execute("
select count(*) cnt from  transkasir1 where nid in $mrekap 
");
...
$sqlstr="select a.nid,date_format(a.tgl,'%d-%m-%Y') tgl,date_format(DATE_ADD(a.tgl, INTERVAL c.tempo DAY),'%d-%m-%Y') tgljt,
