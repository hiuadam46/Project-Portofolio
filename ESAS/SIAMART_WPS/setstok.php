...
echo("<th rowspan=2> Nama </th>")         	;$mwd5='50 readonly';
echo("<th rowspan=2> Sat </th>")          	;$mwd6='4  readonly';
echo("<th rowspan=2> Isi </th>")          	;$mwd7='5   readonly';
echo("<th rowspan=2> Sat </th>")          	;$mwd8='4  readonly';
echo("<th rowspan=1 colspan=5> Harga </th>")   	;$mwd910111213='10  readonly';
echo("<th rowspan=2> Print<br>L/B </th>")    	;$mwd14='3';
echo("</tr>");

echo("<th rowspan=1> 1 </th>")   ;$mwd3='12  readonly';
echo("<th rowspan=1> 2 </th>")   ;$mwd4='12  readonly';
echo("<th rowspan=1> Beli </th>")   ;$mwd9='8  readonly';
echo("<th rowspan=1> Jual A </th>");$mwd10='8  readonly';
echo("<th rowspan=1> Jual B </th>") ;$mwd11='8  readonly';
echo("<th rowspan=1> Jual C </th>")   ;$mwd12='8 readonly';
echo("<th rowspan=1> Jual D </th>")   ;$mwd13='8 readonly';
echo("</tr>");
...
for ($ggg=1;$ggg<101;$ggg++)
	{
		...
		value='".number_format($rows[hrgjual4],0,'.',',')."' $nstt2 ></td>
		";
...
<tr><td><input type=checkbox id='ck12' value='hrgjual4'  checked >Hrg. Ecer </td></tr>
