...
<meta http-equiv="content-type" content="text/html; charset=ISO-8859-1">
  ...
  $Pcs2(document).ready(function(){
	...
	{
		mnid=$Pcs2("#mnid").val()
		mgg=taptabel("bkbesar", "tgl, nid, bpid, sum(kredit) kredit, rekid", "nid='"+mnid+"' and nid2<>'' and kredit>0 group by tgl, nid, bpid");
		mgi=taptabel("bkbesar", "tgl, nid, bpid, rekid", "nid='"+mnid+"' and rekid like '101%'");
		mgj=taptabel("setrek", "rekid, reknama", "rekid='"+mgi.rekid+"'");
		...
		if (mgg.nid!=undefined)
		{
			...
			$Pcs2("#mket").val(mgg.ket)
			$Pcs2("#mlgnid").blur()
			//document.getElementById('mrekid').innerHTML = "<option value="+mgi.rekid+">"+mgi.rekid+"-"+mgj.reknama+"</option>";
			$Pcs2("#mrekid").val(mgi.rekid);
