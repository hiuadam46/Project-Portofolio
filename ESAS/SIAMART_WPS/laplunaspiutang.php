...
<html><head>
	...
	function buatlaporan(ngeprint, excel)
	{
			...
			if(!excel)
			{
				if (!ngeprint)
				{
					$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlaplunaspiutang&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mrute="+mrute+"&mjnsbayar="+mjnsbayar);
				}
				else
				{
					window.open("isilaporan.php?mLapo=mlaplunaspiutang&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mrute="+mrute+"&mjnsbayar="+mjnsbayar+"&isprint=YY");
				}
			}
			else
			{
				window.open("isilaporan.php?mLapo=mlaplunaspiutang&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mrute="+mrute+"&mjnsbayar="+mjnsbayar+"&isprint=YY");
			}
	}
    </script>
    <script type="text/javascript">
...
<?php 
	require("menu.php");
?>	
	<form name='fform' id='fform' style="font-family:Arial;color:white">
