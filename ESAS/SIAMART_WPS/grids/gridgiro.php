...
echo("<th rowspan=1> No Giro </th>");$mwd2='10 ';
echo("<th rowspan=1> Tgl. Cair </th>");$mwd3='10 ';
echo("<th rowspan=1> Nama Bank Giro </th>");$mwd4='40 ';
...
if (substr($mnid,0,2)=='LH')
{$mrekid='20110';}

if (substr($mnid,0,2)=='LP')
{$mrekid='10220';}
...
where a.nid='$mnid' and a.rekid='$mrekid' and ket like '%Pelunasan%'";
