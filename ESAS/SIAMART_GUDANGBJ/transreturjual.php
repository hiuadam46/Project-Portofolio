			...
			success : function(data)
			{
				...
				for (gg=1;gg<100;gg++)
				{
					...
					if (mstoid!='')
					{
						...
						mq1="insert into transreturjual2(nomor, nid, tgl, stoid, qty, unit, totqty, hrgsat, jmlhrg, isi, diskonrp) "
				...
				xxw=window.open('printreturjual.php?mnid='+mnid+'&mkasir='+mkasir, 'aa', ('alwaysraised=yes, scrollbars=no, resizable=no, height=550, left=200, top=10'));
				xxw.focus();
...
<form id="fform" name="fform">
	<table border="0" style="font-family: Arial; color: white; font-weight: bold" width="100%">
		<tr>
			<td style="width:105px">Tgl. </td>
			<td>: <input id="mtgl" size="10" type="text"> Kode :
			<input id="mnid" size="10" type="text"><input id="lookmnid" type="button" value="F5"></td>
		</tr>
		<tr>
			<td>Pelanggan </td>
			<td colspan="5">: <input id="mlgnid" size="5" type="text"><input id="lookmlgnid" type="button" value="F5"><input id="mlgnnama" disabled size="45" type="text"><input id="mkasir" disabled size="45" type="text" value="<?php echo $_SESSION["MANA"] ?>" style="display:none"></td>
		</tr>
		<tr>
			<td>Catatan </td>
