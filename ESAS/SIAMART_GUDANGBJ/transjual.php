  ...
  $Pcs2(document).ready(function(){
	...
	$Pcs2("#btnsimpan").click(function() {
		...
		if (mgg.hutang!=undefined)
		{
			...
			mq1="insert into transjual1(nid,tgl,tgljt,ket,lgnid,total,tunai,jumlah,sales,status) "
			mq2=" values('"+mnid+"',"+mtgl+","+mjt+",'"+mket+"','"+mlgnid+"','"+mtotal+"','"+mtunai+"','"+mhutang+"','"+mkarid+"',2)"
			execajaxas(mq1+mq2)
			
			
			mtot=0			
			mq11="insert into transjual2(nomor,nid,tgl,stoid,qty,unit,extra,extraunit,totqty,hrgsat,jmlhrg,isi,diskonrp) values"
			...
			mq11=mq11+" ('"+gg+"','"+mnid+"',"+mtgl+",'"+mstoid+"','"+mqty+"','"+munit+"','"+mextra+"','"+mextraunit+"','"+mtotqty+"','"+mhrgsat+"','"+mjmlhrg+"','"+misi+"','"+mdisk+"'), "
			mtot=mtot+toval(mjm)
...
///awal functions
	...
	function baru(mgdn)
	{
		...
		// execajaxas("delete from transjual2 where nid='"+mmmerkid+"' or nid='xcx'")
		$Pcs2("#mlgnid").focus()
