...
/* echo '<tr><td>Nama Alias </td><td> : <input type=text name=malias id=malias size=50 maxlength="200" value='.$mstok[alias].' title="Isikan Nama Alias Stok">'; */
?>
<form id="fform">
	<table style="width:100%">
		<tr>
			<td style="width:89px">Kode Stok </td>
			<td>:
		...
		<tr>
			<td>Barcode 2 </td>
			<td>:
			<input id="mbarcode2" maxlength="20" name="mbarcode2" size="20" type="text" value="<?php echo $mstok[barcode2] ?>"></td>
		</tr>
		<tr>
			<td>Grup</td>
			<td>:
	...
	<table border="0" style="border-color: aqua" width="100%">
		<tr>
			...
			Isi :
			<input id="misi" name="misi" size="5" style="max-width: 50pt" value="<?php echo $mstok[isi] ?>"><input id="msatuan2" disabled name="msatuan2" size="5" type="text" value="<?php echo $mstok[satuan2] ?>"></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="left">Hrg. Jual grosir2 </td>
			<td colspan="3">:
	...
	<input id="tutup" type="button" value="Tutup"><label id="Labellt" style="font-size:14pt;vertical-align:top;font-family:Verdana">&nbsp;&lt;</label><input id="btnsaldo" type="button" value="Saldo Awal"><label id="Labelgt" style="font-size:14pt;vertical-align:top;font-family:Verdana">&gt;</label>
	<div id="kotakdialog2" style="color: white; font-size: 4pt; font-family: Verdana">
		<center>
		<iframe id="framehrg" height="350" style="top: 300px" width="100%">
		</iframe></center></div>
</form>
...
$Pcs2(document).ready(function()
{
	...
	$Pcs2('#mhrgjual').blur(function()
	{
		cekharga(this);
	})
	
	$Pcs2('#mhrgjual2').blur(function()
	{
		cekharga(this);
	})
	
	$Pcs2('#mhrgjual4').blur(function()
	{
		cekharga(this);
	})
	...
	{
		cmhrgjual=cekharga($Pcs2('#mhrgjual'));
		//alert(cmhrgjual);
		if(cmhrgjual==false)
		{
			return;
		}
		cmhrgjual2=cekharga($Pcs2('#mhrgjual2'));
		//alert(cmhrgjual2);
		if(cmhrgjual2==false)
		{
			return;
		}
		cmhrgjual4=cekharga($Pcs2('#mhrgjual4'));
		//alert(cmhrgjual4);
		if(cmhrgjual4==false)
		{
			return;
		}
		cmhrgjual3=cekharga($Pcs2('#mhrgjual3'));
		//alert(cmhrgjual3);
		if(cmhrgjual3==false)
		{
			return;
...
function cekharga(tag)
{
	//alert($Pcs2("#mhrgbeli").val());
	//alert($Pcs2(tag).val());
	if(parseFloat($Pcs2(tag).val())<parseFloat($Pcs2("#mhrgbeli").val()) || $Pcs2(tag).val()=='')
	{
		alert("Harga tidak boleh lebih kecil dari Harga Beli="+$Pcs2("#mhrgbeli").val());
		$Pcs2(tag).select();
		return false;
	}
	else
