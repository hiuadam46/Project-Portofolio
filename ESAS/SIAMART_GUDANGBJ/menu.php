...
<div id="mmnu" style="text-align: right">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<label style="font-size: 14pt; font-family: Verdana; color: white; text-decoration: underline">
			GUDANG BALI JAYA </label></b><br>
			<span id="subtitle" style="font-family: Verdana; color: white">Blitar</span></td>
			<td valign="top">
...
('PEMBELIAN','topmenu','Barang Masuk','','','','1','1'), 
	('TRANSPEMBELIAN','','Barang Masuk','transbeli.php','','PEMBELIAN','1','1'),
	('TRANSRETURPEMBELIAN','','Retur Masuk','transreturjual.php','','PEMBELIAN','1','1'),
('PENJUALAN','topmenu','Barang Keluar','','','','1','1'), 
	('TRANSJUAL','','Barang Keluar','transjual.php','','PENJUALAN','1','1'),
	('TRANSRETURPEMBELIAN','','Retur Keluar','transreturbeli.php','','PENJUALAN','1','1'),
('STOK','topmenu','Stok','','','','1','1'), 
	('TRANSSESUAI','','Penyesuaian Stok','transsesuai.php','','STOK','1','1'),
('LAPORAN','topmenu','Laporan','','','','1','1'),
	('LAPJUALKIRIMAN','','Rekap Barang Keluar','lapjualkiriman.php','','LAPORAN','1','1'),
	('LAPJUAL','','Laporan Barang Keluar','lapjual2.php','','LAPORAN','1','1'),
	('LAPJUALDITEL','','Laporan Barang Keluar Detail','lapjual3.php','','LAPORAN','1','1'),
	('LAPDISTRIBUSI','','Distribusi Barang Keluar','lapdistribusi.php','','LAPORAN','1','1'),
	('LAPBELI','','Barang Masuk','lapbeli2.php','','LAPORAN','1','1'),
	('LAPBELI2PERIODIK','','Barang Masuk Per Nota','lapbeli2periodik.php','','LAPORAN','1','1'),
	('LAP2BELI','','Barang Masuk Detail','lapbeli3.php','','LAPORAN','1','1'),
	('LAPSTOK','','Stok','','','LAPORAN','1','1'),
		('LAPDFSTOK','','Laporan Daftar Stok','lapdaftarstok.php','','LAPSTOK','1','1'),
		('LAPDFSTOK','','Laporan Saldo Stok ','lapdaftarstoksales.php','','LAPSTOK','1','1'),
...
--></li>
				<li class="toplast">
				<a href="#" style="height: 19px; line-height: 19px;"><span>
