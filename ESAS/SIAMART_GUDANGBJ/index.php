...
<div id="kotak" class="demo" style="font-family: Arial; font-size: 12pt">
	ID : <br><input id="username" type="password"> <span id="pesan">
	<label style="font-size: 8pt">Isi lalu tekan enter</label></span><p>Password 
	: <br><input id="password" type="password"> <span id="pesan2">
