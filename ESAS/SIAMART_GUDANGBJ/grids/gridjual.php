...
echo("<th rowspan=2> Harga </th>");$mwd12='6 readonly';
echo("<th rowspan=2> Dis<br>Rp. </th>");$mwd13='5';
echo("<th rowspan=2> Jumlah </th>");$mwd14='12 readonly';
echo("<th rowspan=2> isi </th>");$mwd15='8 readonly';
echo("</tr>");
...
<th   hidden><input size=$mwd11 type='text' readonly $msty></th>
...
FORMAT(hrgsat,0) hrgsat,FORMAT(diskonrp,0) diskon,FORMAT(jmlhrg,0) jmlhrg
from transjual2 a 
where a.nid='$mnid' 
order by nomor";
...
while ($rows=mysql_fetch_object($rrw))
	...
	<tr>
	<td bgcolor='white' rowspan=1 colspan=7 align=center>&nbsp;<font color=red><span id='spanket'></span></td>
	<td bgcolor='white' colspan=2 align=right>Total&nbsp;&nbsp;</td>
	<td bgcolor='white'><input size=$mwd14 type='text'  $nstt2 readonly id='mtotal'></td>
	</tr>

	<tr hidden>
	<td  bgcolor='white' colspan=2 align=right>Ongkos&nbsp;&nbsp;</td>
	...
	<td   hidden bgcolor='white'><input size=$mwd11 type='text'  $msty readonly></td>
