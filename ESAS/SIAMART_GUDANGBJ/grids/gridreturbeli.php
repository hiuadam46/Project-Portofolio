...
/* $query="
select a.stoid, FORMAT(a.qty, 0) qty, FORMAT(a.unit, 0) unit, FORMAT(a.extra, 0) extra, FORMAT(a.extraunit, 0) extraunit, FORMAT(hrgsat, 0) hrgsat, FORMAT(diskonp, 2) diskon, FORMAT(jmlhrg, 0) jmlhrg
...
while ($rows=mysql_fetch_assoc($rrw))
{
	...
	$mjrow=$mjrow+1;
	$midname="id='19".'_'."$mnom' name='19".'_'."$mnom'";
	echo "
