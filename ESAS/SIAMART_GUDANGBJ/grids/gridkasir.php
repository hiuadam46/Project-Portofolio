...
echo("<th rowspan=1> Input [F5]</th>");$mwd2='7';
echo("<th rowspan=1> Kode </th>");$mwd21='7 disabled';
echo("<th rowspan=1  > Uraian </th>");$mwd3='55 readonly';
...
echo("<th rowspan=1> Diskon </th>");$mwd7='8 readonly';
echo("<th rowspan=1> Jumlah </th>");$mwd8='12 readonly';
echo("<th rowspan=1> Isi </th>");$mwd9='4 readonly';
...
$query="select a.stoid,FORMAT(a.qty,2) qty,FORMAT(a.hrgsat,0) hrgsat,cdiskon diskon,FORMAT(a.jmlhrg,0) jmlhrg,a.satuan,a.isi,b.stonama
...
while ($rows=mysql_fetch_assoc($rrw))
	{
		...
		value='' $nstt onblur='ambilstok(this)'></td>
		";
		...
		value='".$rows[retur]."'  onclick=rumus1() disabled></td>
		";
