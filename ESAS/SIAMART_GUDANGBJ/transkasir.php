...
function arah2(theid)
{
	...
	function baru(mgdn)
	{
		...
		$Pcs2("#lblwalk").html("GUDANG BALI JAYA  Siap Melayani Anda")
...
?>
	...
	<input type=button value='Simpan' id='btnsimpan'> <br><br></td></tr>
	</table>
	...
	<input type='button' value='F12-Baru'  id='btnkeluar'>
