...
echo("<th rowspan=1 colspan=5> Harga </th>")   	;$mwd9101112='10  readonly';
...
echo("<th rowspan=1> Special </th>");$mwd10='8  readonly';
echo("<th rowspan=1> Grosir1 </th>") ;$mwd11='8  readonly';
echo("<th rowspan=1> Grosir2 </th>") ;$mwd12='8  readonly';
echo("<th rowspan=1> Ecer </th>")   ;$mwd13='8 readonly';
echo("</tr>");
...
success : function(data){
		...
		nn=1;
	        $Pcs2.each(data, function(index, array) {
	            ...
	            $Pcs2("#23_"+nn).val(tra(toval(array['hrgjual3'])));
   		    $Pcs2("#bodiv_"+nn).show();
		    nn++;
	        });
