...
<title>Laporan Pembelian 2</title>
...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapbeli3&mtg1="+mtgl1+"&mtg2="+mtgl2+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapbeli3&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapbeli3&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
	}
}
</script>
<script type="text/javascript">
