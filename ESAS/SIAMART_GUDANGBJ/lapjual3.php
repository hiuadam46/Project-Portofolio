...
<html><head>
	...
	function buatlaporan(ngeprint, excel)
	{
		...
		if(!excel){
			if (!ngeprint)
			{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapjual3&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mstoid="+$Pcs2("#mstoid").val())
			}
			else
			{
			window.open("isilaporan.php?mLapo=mlapjual3&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mstoid="+$Pcs2("#mstoid").val())
			}
		}
		else{
			window.open("isilaporan.php?mLapo=mlapjual3&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mstoid="+$Pcs2("#mstoid").val())
