...
<meta http-equiv="content-type" content="text/html; charset=ISO-8859-1">
	...
	$Pcs2(document).ready(function(){
		...
		$Pcs2(document).keydown(function(){
			...
			if (mobj=='setstok1')
			{
			opener.fsetstok.msatuan.value=isi;
			self.close();
			opener.focus();
			opener.fsetstok.msatuan.focus();
			opener.fsetstok.msatuan.blur();
			opener.fsetstok.misi.select();
			return;
			}
...
<?php
	echo("request:".'"msql=select * from setsatuan where concat(satuanid,satuan) like'."'!!".$mCari."!!'".'"');
?>	
    };
