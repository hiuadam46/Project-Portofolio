...
?>	
	...
	FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='siamart_gudangbj_data' and TABLE_NAME='setsup' 
	and COLUMN_COMMENT<>'' and COLUMN_NAME in ('supid','supnama','alamat','telp','tempo','kontak','keterangan') 
