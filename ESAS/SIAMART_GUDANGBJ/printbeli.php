...
$rowx=execute("select count(*) cnt from transbeli2 where nid='$mnid'");
...
$sqlstr="select a.*,b.supnama  from transbeli1 a left join setsup b on a.supid=b.supid where a.nid='$mnid' ";
...
<td width=7% colspan=2><b>Barang Masuk</td>
<td width=33%>&nbsp;</td>
</tr>

<tr>
<td width=3%>Blitar</td>
<td width=50% colspan=2>Dari : $msupnama</td>
</tr>
...
$sqlstr="select a.*,left(b.stonama,30) stonama,b.satuan1,b.satuan2 from transbeli2 a left join setstok b on a.stoid=b.stoid where a.nid='$mnid' and a.stoid<>''  order by nomor limit 0,100" ;
$result = mysql_query ($sqlstr) or die ("Kesalahan pada perintah SQL! Jual 2");
