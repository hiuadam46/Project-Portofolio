...
$msqql2="            select '10310' ,a.stoid ,'L001',a.tgl ,a.nid ,a.totqty    ,a.jmlhrg,'TRANSBELI'  ,'Pembelian'   from transbeli2 a left join transbeli1 b on a.nid=b.nid where a.nid like '$mnid%' ";
execute($msqql1.$msqql2);
