...
<html><head>
	...
	function buatlaporan(ngeprint,excel)
	{
			...
			if(!excel)
			{
				if (!ngeprint)
				{
				$Pcs2("#framelap").attr("src","isilapgiro.php?mLapo=mlapgiro&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mrekid="+asd+"&mstoid="+$Pcs2("#mstoid").val())
				}
				else
				{
				window.open("isilapgiro.php?mLapo=mlapgiro&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mrekid="+asd+"&mstoid="+$Pcs2("#mstoid").val())
				}
			}
			else
			{
				window.open("isilapgiro.php?mLapo=mlapgiro&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mrekid="+asd+"&mstoid="+$Pcs2("#mstoid").val())
			}
	}
    </script>
    <script type="text/javascript">
