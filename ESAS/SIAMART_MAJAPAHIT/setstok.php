...
<font color=white>
 ...
 PPN : <select id='misppn' name='misppn' $mtpe value='<?php echo $mstok[isppn]; ?>'> <option value=''>Semua</option> <option value='PPN'>PPN</option> <option value='Non PPN'>Non PPN</option> </select>
...
echo("<th rowspan=1> Hpp Sales </th>");$mwd10='8  readonly';
echo("<th rowspan=1> J.Grosir </th>") ;$mwd11='8  readonly';
echo("<th rowspan=1> J.Ecer </th>")   ;$mwd12='8 readonly';
echo("</tr>");
...
<input type='button' id="tcetak" value="F7 = Print Daftar" >&nbsp;&nbsp;
...
$Pcs2(document).ready(function(){
	execajaxas(" alter table setstok add isppn char(10) default 'Non PPN' comment '17PPN' ")
...
mgrpid=$Pcs2("#mgrpid").val()
mgrpid=mgrpid.substr(0,4)
misppnx=$Pcs2("#misppn").val()

mjadi="func=EXEC&field=count(*) cnt &tabel=setstok&kondisi= ( stonama like '!!"+$Pcs2("#mcar").val()+"!!' or stoid like '!!"+$Pcs2("#mcar").val()+"!!' or barcode like '!!"+$Pcs2("#mcar").val()+"!!' or barcode2 like '!!"+$Pcs2("#mcar").val()+"!!' ) and grpid like '!!"+mgrpid+"!!' and isppn like '"+misppnx+"%' ";
...
if ($Pcs2("#mcar").val()=='')
{
mjadi="func=EXECTAB&field=*&tabel=setstok&kondisi= ( stonama like '!!"+$Pcs2("#mcar").val()+"!!' or stoid like '!!"+$Pcs2("#mcar").val()+"!!' or barcode like '!!"+$Pcs2("#mcar").val()+"!!' or barcode2 like '!!"+$Pcs2("#mcar").val()+"!!' ) and grpid like '!!"+mgrpid+"!!'  and isppn like '"+misppnx+"%' order by stoid,POSITION('"+$Pcs2("#mcar").val()+"' IN stonama),stonama limit "+maww+",100";
}
else
{
mjadi="func=EXECTAB&field=*&tabel=setstok&kondisi= ( stonama like '!!"+$Pcs2("#mcar").val()+"!!'  ) and grpid like '!!"+mgrpid+"!!'  and isppn like '"+misppnx+"%' order by POSITION('"+$Pcs2("#mcar").val()+"' IN stonama),stonama limit  "+maww+",100";
}
