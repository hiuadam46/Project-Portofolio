...
$query="
select a.stoid, FORMAT(a.qty,1) qty, FORMAT(a.unit,0) unit, FORMAT(a.extra,0) extra, FORMAT(a.extraunit,0) extraunit, FORMAT(hrgsat,0) hrgsat, FORMAT(diskonrp,0) diskon, FORMAT(jmlhrg,0) jmlhrg, ratehrgjual
from transjual2 a
where a.nid='$mnid'
order by nomor
";
