...
where a.nid="'.$mnid.'"
');
$querysupir=executerow('
select a.*, b.lgnnama, b.alamat, b.telp, c.karnama
from transjual1 a
left join setlgn b on a.lgnid=b.lgnid
left join setkaryawan c on a.supir=c.karid
where a.nid="'.$mnid.'"
');
$rowjual1=mysql_fetch_assoc($query11);
$rowjualsupir=mysql_fetch_assoc($querysupir);
...
<div>
	<table cellpadding="0" cellspacing="0" style="width: 100%">
		...
		<tr>
			<td colspan="5"><label id="Label2" style="font-weight:">Jl Raya Trowulan No 77 Mojokerto</label></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="5"><label id="Label3" style="font-weight:">Telp 081234338424</label></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>Telp.</td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td style="font-weight: bold">Supir</td>
			<td style="font-weight: bold">:</td>
			<td colspan="6" style="font-weight: bold"><?php echo $rowjualsupir[supir].' '.$rowjualsupir[karnama]; ?>
			</td>
		</tr>
	</table>
