...
$mper=execute('select tgl from periode');
$mtgl=$mper[tgl];
...
echo $mblth;
$mdatabase='siamart_majapahit_data';
...
/***/
	...
	(TABLE_NAME like 'trans%') and TABLE_NAME<>'transnomor' and TABLE_NAME <> 'transpoin1'
	";
	...
	$mnaman=$mperr->NAMA;
	$mdatab=$mperr->DATAB;
	$strdelete = "delete from ".$mdatab.".".$mnaman." where tgl<'$mtgl'";
	execute($strdelete);
