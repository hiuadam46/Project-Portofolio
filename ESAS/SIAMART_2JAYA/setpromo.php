...
WHERE TABLE_SCHEMA='siamart_2jaya_data' and TABLE_NAME='setpromo' and COLUMN_COMMENT <>''
...
while ($row=mysql_fetch_assoc($rww))
{
	...
	$query528=executerow("select promo$mnom as pro from setpromo");
	$eert=mysql_fetch_assoc ($query528);
