...
if ($func=='LOGIN2')
{
	...
	{
		session_start();
		$_SESSION['MASUK']='GAGAAAL';
		$_SESSION['MAPA']='GAGAAAL';
	}
	else
	{
		session_start();
		$_SESSION['MASUK']=$_POST[id];
		$_SESSION['MAPA']=$_POST[password];
		$_SESSION['MANA']=$row[nama];
	}
...
if ($func=='EXECUTETAB')
{
	...
	$mpd=$mtab[password];
	$sql = "$_POST[comm]";
	$query47=executerow($sql);
	$mtab=mysql_fetch_assoc ($query47);
...
if ($func=='EXEC')
{
	...
	$query69=executerow($sql);
	$mtab=mysql_fetch_assoc ($query69);
