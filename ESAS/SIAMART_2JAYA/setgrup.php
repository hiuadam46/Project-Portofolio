...
<html><head>
	...
	execajaxa("insert into setgrp (grpid,grpnama,rekid,diskon) values('"+msu+"','"+$Pcs2("#mgrpnama").val()+"','"+$Pcs2("#mrekid").val()+"','"+$Pcs2("#mdiskon").val()+"')")
...
?>	
	...
	WHERE TABLE_SCHEMA='siamart_2jaya_data' and TABLE_NAME='setgrp' and COLUMN_COMMENT <>''
