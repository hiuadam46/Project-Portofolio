...
<form id="dform" method="POST" onsubmit="if (!this.submitted) return false; else return true;">
	...
	Data dari <input id="jum1" maxlength="5" size="5" value="1"> sampai
	<input id="jum2" maxlength="5" size="5" value="100"> </label>
	<hr style="color: white"><?php
...
for ($ggg=1;$ggg<101;$ggg++)
{
	...
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text_$mnom' $midname size=$mwd2 value='".$rows[stoid]."' $nstt></td>
	";
	...
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text_$mnom' $midname size=$mwd4 value='".number_format($rows[hrgbeli],0,'.',',')."' $nstt2></td>
	";

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo '
			<td bgcolor=lightgrey><input type="text" '.$midname.' size='.$mwd5.' value="'.number_format($rows[saldo1],0,'.',',').'" '.$nstt2.' onkeyup=hitungsimpan(this)></td>
	';

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text_$mnom' $midname size=$mwd6 value='".$rows[satuan1]."' $nstt3></td>
	";

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text_$mnom' $midname size=$mwd7 value='".$rows[isi]."' $nstt3></td>
	";

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo '
			<td bgcolor=lightgrey><input type="text" '.$midname.' size='.$mwd8.' value="'.number_format($rows[saldo2],0,'.',',').'" '.$nstt2.' onkeyup=hitungsimpan(this)></td>
	';

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text_$mnom' $midname size=$mwd9 value='".$rows[satuan2]."' $nstt3></td>
	";

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text_$mnom' $midname size=$mwd10 value='".number_format($rows[jumlah],0,'.',',')."' $nstt2></td>
	";
