...
function buatlaporan(ngeprint)
{
	...
	if (!ngeprint)
	{
		$Pcs2("#framelap").attr("src", "isilaporan.php?mLapo=mdfp&mtg1="+mtgl1+"&mtg2="+mtgl2)
	}
	else
	{
		window.open("isilaporan.php?mLapo=mdfp&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY")
	}
}
</script>
<script type="text/javascript">
...
<form id="fform" name="fform">
	<div style="position: relative; width: 100%; text-align: left; color: black; font-family: Arial">
		<table width="100%">
			<tr>
