...
<div id="kotak0" class="demo" style="font-family: Arial; font-size: 12pt;color:white">
	<span id="pesan3">Silahkan Login :</span></div>
<div id="kotak" class="demo" style="font-family: Arial; font-size: 12pt;color:white">
	ID : <br><input id="username" type="password"><span id="pesan" style="font-size: 12pt"> 
	Isi lalu tekan enter</span><p>Password : <br>
	<input id="password" type="password"><span id="pesan2" style="font-size: 12pt"> 
	Isi lalu tekan enter</span></p>
</div>
