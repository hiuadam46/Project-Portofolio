...
function buatnota()
{
	...
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'Jam : '+abc.$Pcs2("#mjam").val()+'</td></tr>'
	...
	for (gg=1;gg<101;gg++)
	{
		...
		//mretur=abc.$Pcs2("#20_"+gg).attr('checked');
		//if(mretur==false)
		//{
			mjadd=mjadd+'<tr height=0><td colspan=6>'+mstonama+'&nbsp;&nbsp;&nbsp;@'+misi+'</td></tr>'
			/* mjadd=mjadd+'<tr height=0><td align=left>'+padl(mqty,'',6)+'</td><td>&nbsp;'+padl(msatuan,'&nbsp;',5)+'</td><td>X</td><td>'+padl(mhrgsat,'&nbsp;',4)+' @'+tra(Math.round(toval(mhrgsat)/misi))+'</td><td>=</td><td align=right width=10%>'+padl(mjmlhrg,'&nbsp;',12)+'</td></tr>' */
			mjadd=mjadd+'<tr height=0><td align=left>'+padl(mqty,'',6)+'</td><td>&nbsp;'+padl(msatuan,'&nbsp;',5)+'</td><td>X</td><td>'+tra(Math.ceil(toval(mhrgsat)))+' @'+tra(Math.ceil(toval(mhrgsat)/misi))+'</td><td>=</td><td align=right width=10%>'+padl(mjmlhrg,'&nbsp;',12)+'</td></tr>'
		//}
	}
	mjadd=mjadd+'</table>'
	...
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'----------------------------------------'
	mjadd=mjadd+'<tr height=0><td colspan=1>'+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TOTAL </td><td align=right width=10%>'+padl(abc.$Pcs2("#mtotal").val(),'&nbsp;',12)+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=1>'+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;EDC </td><td align=right>'+padl(abc.$Pcs2("#medc").val(),' ',11)+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=1>'+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;BAYAR </td><td align=right width=10%>'+padl(abc.$Pcs2("#mbayar").val(),'&nbsp;',12)+'</td></tr>'
	...
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'&nbsp;'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'========================================'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'-'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'-'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'-'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'========================================'+'</td></tr>'
	mjadd=mjadd+'</table>'
