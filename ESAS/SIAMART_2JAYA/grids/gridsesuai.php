...
<div id="backtabel" style="height:21px; overflow:hidden; background-image: url(../images/nums.jpg); border-color:black; border-style:solid; border-width:1px; bgcolor:white">
	<table border=1 cellpadding=0 cellspacing=0 style="background-image: url(images/nums.jpg); border-collapse:collapse">
		...
		<tr id="bodiv_'.$mnom.'" '.$mhii.'>
			<td align=right><input type="text" id="1_'.$mnom.'" name="1_'.$mnom.'" class="rcell" size=5 value="'.$mnom.'." readonly '.$msty2.'></td>
			<td><input type="text" id="2_'.$mnom.'" name="2_'.$mnom.'" class="rcell" size=12 value="" readonly '.$msty.'></td>
			<td><input type="text" id="3_'.$mnom.'" name="3_'.$mnom.'" class="rcell" size=30 value="" readonly '.$msty.'></td>
			<td><input type="text" id="4_'.$mnom.'" name="4_'.$mnom.'" class="rcell" size=10 value="" readonly '.$msty2.'></td>
			<td><input type="text" id="5_'.$mnom.'" name="5_'.$mnom.'" class="rcell" size=5 value="" readonly '.$msty.'></td>
			<td><input type="text" id="6_'.$mnom.'" name="6_'.$mnom.'" class="rcell" size=10 value="" readonly '.$msty2.'></td>
			<td><input type="text" id="7_'.$mnom.'" name="7_'.$mnom.'" class="rcell" size=10 value="" readonly '.$msty2.'></td>
			<td><input type="text" id="8_'.$mnom.'" name="8_'.$mnom.'" class="rcell" size=5 value="" readonly '.$msty2.'></td>
			<td><input type="text" id="9_'.$mnom.'" name="9_'.$mnom.'" class="rcell" size=10 value="" readonly '.$msty2.'></td>
		</tr>
	</table>
</div>
...
$query='
select a.*, b.stonama, b.satuan1, b.satuan2, b.isi
from transsesuai a
...
while ($rows=mysql_fetch_assoc($rrw))
{
	...
	{
		echo '
			<td><input type="text" id="2_'.$mnom.'" name="2_'.$mnom.'" class="rcell" size=12 value="'.$rows[stoid].'" '.$msty.' onblur=ambilstok(this)></td>
		';
	}
	else
	{
		echo '
			<td><input type="text" id="2_'.$mnom.'" name="2_'.$mnom.'" class="rcell" size=12 value="'.$rows[stoid].'" '.$msty.'></td>
		';
	}
	...
	echo '
			...
			<td><input type="text" id="5_'.$mnom.'" name="5_'.$mnom.'" class="rcell" size=5 value="'.$rows[satuan1].'" '.$msty.' readonly></td>
			...
			<td><input type="text" id="8_'.$mnom.'" name="8_'.$mnom.'" class="rcell" size=5 value="'.$rows[satuan2].'" '.$msty.' readonly></td>
			...
			<td><input type="text" id="11_'.$mnom.'" name="11_'.$mnom.'" class="rcell" size=10 value="'.$rows[hrgbeli].'" '.$msty2.' readonly></td>
		</tr>
	';
	$mnom++;
}
