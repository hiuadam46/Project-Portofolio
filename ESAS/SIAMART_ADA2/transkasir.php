...
$Pcs2(document).ready(function()
{
	...
	$Pcs2("#btnkeluar2").click(function()
	{
		...
		if(isFilled() == true && $Pcs2('#mnid').val() == ''){
...
function baru(mgdn)
{
	...
	$Pcs2("#lblwalk").html("ADA SENTOSA STATIONERY Siap Melayani Anda")
...
<form id="fform" name="fform">
	<table border="0" style="border-collapse: ; color: white; font-family: Arial; font-weight: bold" width="100%">
		...
		<tr>
			...
			<label id="lblwalk" style="font-size: 18pt">ADA SENTOSA STATIONERY 
...
?>
<input id="btnkeluar2" type="button" value="Keluar" style='color:red'>
