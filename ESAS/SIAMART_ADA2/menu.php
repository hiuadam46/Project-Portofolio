...
function closeKasir(){
	iskasir = $Pcs2('#iskasir').val()

	if(iskasir == 1){
		$Pcs2('#btnkeluar2').click()
	}else{
		window.close()
	}
}
...
<input type="text" value='<?php echo $iskasir;?>' id='iskasir' hidden>
<div id="mmnu" style="text-align: right">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			ADA SENTOSA STATIONERY</label></b><br>
			<span id="subtitle" style="color: white; font-family: Verdana">Maospati Magetan</span></td>
			<td valign="top">
...
--></li>
				<li class="toplast">
				<a href="#" onclick='closeKasir()' style="height: 19px; line-height: 19px;"><span>
