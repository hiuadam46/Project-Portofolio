...
FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='esae1797_pancurmas' and TABLE_NAME='$mtabelnya'
";
...
{
$msql="SELECT COLUMN_NAME kolom,DATA_TYPE tipe,NUMERIC_PRECISION panjang1,CHARACTER_MAXIMUM_LENGTH panjang2,COLUMN_COMMENT koment
FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='esae1797_pancurmas' and TABLE_NAME='$mtabelnya' and COLUMN_NAME in ($mkol)
";
}
...
if ($mLapo=='mlapjualnota')
{
	...
	{
		echo("
		Toko PANCURMAS Motor (PPN)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NPWP : 06.628.748.3-645.000
		<br>
		Laporan Penjualan Per Nota
		<br>Tgl. $mtg1 s.d. $mtg2 $mtgt
		<br><br>
	...
	{
		echo("
		Toko PANCURMAS Motor (NonPPN)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NPWP : 06.628.748.3-645.000
		<br>
		Laporan Penjualan Per Nota
		<br>Tgl. $mtg1 s.d. $mtg2 $mtgt
		<br><br>
