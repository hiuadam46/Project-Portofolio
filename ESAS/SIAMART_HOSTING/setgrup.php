...
$Pcs2(document).ready(function()
{
	...
	$Pcs2("#tcetak").click(function()
	{
		window.open("isilaporan.php?mLapo=mSetup&isprint=YY&mtabelnya=setgrp&detitle=Master Grup<br>")
	})
});
</script>
...
WHERE TABLE_SCHEMA='esae1797_pancurmas' and TABLE_NAME='setgrp' and COLUMN_COMMENT <>''
