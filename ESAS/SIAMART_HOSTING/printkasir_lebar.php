...
$tgljatuh=str_replace('01-01-1970', '', date('d-m-Y',strtotime($rowjual1[tgljt])));
...
<div>
	<table cellpadding="0" cellspacing="0" style="width: 100%">
		...
		<tr>
			...
			<label id="Label1" style="display: ">Toko PANCURMAS Motor</label></td>
			<td>&nbsp;</td>
			<td style="font-weight: bold; font-size: 14pt; text-align: center">FAKTUR PENJUALAN</td>
			<td>&nbsp;</td>
			<td>Kepada</td>
			<td>:</td>
		...
		<tr>
			<td colspan="5"><label id="Label2" style="display: ">Desa Harjokuncaran no 1 RT 9. RW3, kec Sumbermanjing wetan.</label></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="5"><label id="Label3" style="display: ">Telp 0812-2922-5497</label></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>Telp.</td>
	...
	<table cellpadding="0" cellspacing="0" style="width: 100%;height:103mm">
		<thead>
			<tr style="border-style: solid; border-width: 1px">
				...
				<th colspan="7" style="<?php echo borders(1,0,1,1,2) ?>">&nbsp; HARGA</th>
...
<?php
	if($j==$jumlahhal-1)
	{
		echo '
			<tr>
				<td style="'.borders(0,0,1,0,2).'">&nbsp;</td>
				<td colspan="2" style="'.borders(0,0,1,0,2).'">Jatuh Tempo 
				: '.$tgljatuh.'</td>
				<td style="'.borders(0,0,1,0,2).'">&nbsp;</td>
				<td style="'.borders(0,0,1,0,2).'">&nbsp;</td>
				<td style="'.borders(0,0,1,0,2).'">&nbsp;</td>
				<td style="'.borders(0,0,1,0,2).'">&nbsp;</td>
				<td style="'.borders(0,0,1,0,2).'">&nbsp;</td>
				<td colspan="6" style="font-weight: bold; text-align: right; '.borders(1,0,1,0,2).'" rowspan="2">
				Total :</td>
				<td colspan="2" style="font-weight: bold; text-align: right; '.borders(0,1,1,0,2).'" rowspan="2">
				'.number_format($rowjual1[total],0,".",",").'&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td>Terbilang :</td>
			...
			<tr>
				...
				<td colspan="6" style="vertical-align: top" rowspan="2">==='.$terbilang.' 
				rupiah=== </td>
				<td>&nbsp;</td>
				<td colspan="6" style="font-weight: bold; text-align: right; '.borders(1,0,0,1,2).'">
				Bayar :</td>
				<td colspan="2" style="font-weight: bold; text-align: right; '.borders(0,1,0,1,2).'">
				'.number_format($rowjual1[bayar],0,".",",").'&nbsp;</td>
			</tr>
			<tr>
				<td style="vertical-align: top;">&nbsp;</td>
				<td>&nbsp;</td>
				<td colspan="6" style="font-weight: bold; text-align: right; '.borders(1,0,0,0,2).'">
				Kembali :</td>
				<td colspan="2" style="font-weight: bold; text-align: right; '.borders(0,1,0,0,2).'">
				'.number_format($rowjual1[kembali],0,".",",").'&nbsp;</td>
			</tr>
		';
	}
	else
	{
		echo '
			<tr>
				<td style="text-align: right; '.borders(0,0,0,1,2).'">&nbsp;</td>
				<td style="'.borders(0,0,0,1,2).'" colspan="3">&nbsp;</td>
				<td style="text-align: right; '.borders(0,0,0,1,2).'">&nbsp;</td>
				<td style="'.borders(0,0,0,1,2).'">&nbsp;</td>
				<td style="text-align: right; '.borders(0,0,0,1,2).'">&nbsp;</td>
				<td style="'.borders(0,0,0,1,2).'">&nbsp;</td>
				<td style="text-align: right; '.borders(0,0,0,1,2).'">&nbsp;</td>
				<td style="'.borders(0,0,0,1,2).'">&nbsp;</td>
				...
				<td style="'.borders(0,0,0,1,2).'">&nbsp;</td>
				<td style="'.borders(0,0,0,1,2).'">&nbsp;</td>
				<td style="text-align: right; '.borders(0,0,0,1,2).'" colspan="2">&nbsp;</td>
				<td style="text-align: right; '.borders(0,0,0,1,2).'">&nbsp;</td>
			</tr>
...
?>
			<tr>
				...
				<?php echo number_format($mtjpoin,0,".",","); ?>&nbsp;</td>
			</tr>
		</tfoot>
	</table>
	<table cellpadding="0" cellspacing="0" style="width: 100%">
