...
function buatnota()
{
	...
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'METRO BIKE SHOP'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Jl Bromo No 10 Wlingi Blitar'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Telp 0342-694469'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'================================'+'</td></tr>'
