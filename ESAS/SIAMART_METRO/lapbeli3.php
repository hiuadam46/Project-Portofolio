...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapbeli3&mtg1="+mtgl1+"&mtg2="+mtgl2+"&msupid="+asd+"&mgrpid="+mgrpid);
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapbeli3&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mgrpid="+mgrpid);
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapbeli3&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mgrpid="+mgrpid);
	}
}
</script>
<script type="text/javascript">
