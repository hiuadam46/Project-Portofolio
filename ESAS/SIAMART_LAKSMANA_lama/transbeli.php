...
$Pcs2(document).ready(function()
{
	...
	{	if ($Pcs2("#mnid").val()=='')
		...
		mkat=" insert into transbeli2(nomor, nid, tgl, stoid, qty, unit, extra, extraunit, totqty, hrgsat, jmlhrg, isi, diskonrp) values "
...
<form id="fform" name="fform">
	...
	<div id="kotakdialog2" title="Setup Pelanggan">
		<center>
			<iframe id="framehrg" height="450" width="100%"></iframe>
		</center>
	</div>
</form>
