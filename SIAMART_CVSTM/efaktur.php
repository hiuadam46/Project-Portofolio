...
<html><head>
	...
	function buatlaporan(ngeprint,excel)
	{
			...
			if(!excel)
			{
				if (!ngeprint)
				{
					$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=efaktur&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&msalesid="+msalesid)
				}
				else
				{
					window.open("isilaporan.php?mLapo=efaktur&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&msalesid="+msalesid)
				}
			}
			else
			{

				window.open("isilaporan.php?mLapo=efakturexcel&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&msalesid="+msalesid)
			}
	}
    </script>
    <script type="text/javascript">
...
?>	
	...
	<tr>
		...
		Sales <input type=text id=msalesid size=8><input type='button' id=mlsales value='F5'><input type=text id=msalesnama readonly> </td>
	</tr>	
