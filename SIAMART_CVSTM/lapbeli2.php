...
<html><head>
	...
	function buatlaporan(ngeprint,excel)
	{
			...
			if(!excel)
			{
				if (!ngeprint)
				{
				$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapbeli2&mtg1="+mtgl1+"&mtg2="+mtgl2+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val()+"&misppn="+misppn)
				}
				else
				{
				window.open("isilaporan.php?mLapo=mlapbeli2&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val()+"&misppn="+misppn)
				}
			}
			else
			{
				window.open("isilaporan.php?mLapo=mlapbeli2&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val()+"&misppn="+misppn)
			}
	}
    </script>
    <script type="text/javascript">
	...
	{
		misppn=$Pcs2("#misppn").val()
		mcomm="Select rpad(supid,12,' ') Kode,left(supnama,50) Nama from setsup where isppn like '"+misppn+"%'"
		mordd="Kode"
