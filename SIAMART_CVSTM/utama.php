...
if ($mjumlah>$msaldo)
{$mqtyouts=$msaldo;$mkredits=$mhpp*$msaldo;}
else
{$mqtyouts=$mjumlah;$mkredits=$mhpp*$mjumlah;}

if ($mqtyouts==''){$mqtyouts=$mjumlah;$mkredits=$mhbel*$mjumlah;}
