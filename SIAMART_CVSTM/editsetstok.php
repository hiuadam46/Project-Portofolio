...
<tr><td align=left>PPN&nbsp;</td><td> : <select id='misppn' name='misppn' $mtpe value='<?php echo $mstok[isppn]; ?>'> <option value='PPN'>PPN</option> <option value='Non PPN'>Non PPN</option> </select></td></tr>
</table>
  ...
  document.getElementById('mhrgjual3').onkeypress = function(e){
    ...
    if (keyCode == 'Enter'){
	  ...
	  if (document.getElementById('mhrgjual3').value == 0) {
      	alert('Harga jual ecer tidak boleh kosong'); 
	  }
    }
  }
...
$Pcs2("#misppn").val('<?php echo $mstok[isppn] ?>')
...
///	
    ...
    $Pcs2('#bsimpan').click(function(){ //newsimpan
		...
		if (stat == 'Simpan') {
			mq1="insert into setstok(grpid, stoid, stonama, alias, barcode, barcode2, satuan, satuan1, satuan2, satuan3, hrgbeli, hrgjual, hrgjual2, hrgjual3, hrgjual4, isi, isi2, minimal, supid, qty3, jmlhrg, aktif, nomor, grpidold, pb, isppn) ";
			mq2=" values('"+grpid+"','"+stoid+"','"+stonama+"','"+alias+"','"+barcode+"','"+barcode2+"','"+satuan+"','"+satuan1+"','"+satuan2+"','"+satuan3+"','"+hrgbeli+"','"+hrgjual+"','"+hrgjual2+"','"+hrgjual3+"','"+hrgjual4+"','"+isi+"','"+isi2+"','"+minimal+"','"+supid+"','"+qty3+"','"+jmlhrg+"','"+aktif+"','"+nomor+"','"+grpidold+"','"+pb+"','"+isppn+"')";
			execajaxas(mq1+mq2);
			// alert(mq2);
		}else{
			execajaxa("UPDATE setstok SET grpid='"+grpid+"',stonama='"+stonama+"',alias='"+alias+"',barcode='"+barcode+"',barcode2='"+barcode2+"',satuan='"+satuan+"',satuan2='"+satuan2+"',satuan3='"+satuan3+"',hrgbeli='"+hrgbeli+"',hrgjual='"+hrgjual+"',hrgjual2='"+hrgjual2+"',hrgjual3='"+hrgjual3+"',hrgjual4='"+hrgjual4+"',isi='"+isi+"',isi2='"+isi2+"',minimal='"+minimal+"',supid='"+supid+"',qty3='"+qty3+"',jmlhrg='"+jmlhrg+"',aktif='"+aktif+"',nomor='"+nomor+"',grpidold='"+grpidold+"',pb='"+pb+"',isppn='"+isppn+"' WHERE stoid='"+stoid+"'")
