 ...
 $Pcs2("#kotakdialog2").dialog({
	...
	$Pcs2("#fform").keydown(function() {	
		...
		if (mmid.substr(0,2)=='12' && (mmv==116 || (mmv==13 && mmf2.value=='') ))
		{
			...
			//1 mei 2021 jika gol=null set mh=3(to default)
			if (mgolongan==undefined)
			{
				mh='3'
			}
			//1 mei 2021
	...
	$Pcs2("#mlgnid").blur(function() {
		...
		//1 mei 2021 tidak ada object mjt
	...
	$Pcs2("#btnsimpan").click(function()
	{
		...
		$Pcs2.ajax(
		{
			...
			success : function(data)
			{
				...
				mq1="insert into transreturjual1(nid, tgl, jualid, ket, lgnid, total, status, sales) ";
				mq2=" values('"+mnid+"', "+mtgl+", '"+mjualid+"', '"+mket+"', '"+mlgnid+"', '"+mtotal+"', 2, '"+mkarid+"')";
