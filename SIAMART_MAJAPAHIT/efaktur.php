...
<html><head>
	...
	function buatlaporan(ngeprint,excel)
	{
			...
			if(!excel)
			{
				if (!ngeprint)
				{
					$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=efaktur&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&msalesid="+msalesid+"&mgrpid="+mgrpid)
				}
				else
				{
					window.open("isilaporan.php?mLapo=efaktur&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&msalesid="+msalesid+"&mgrpid="+mgrpid)
				}
			}
			else
			{

				window.open("isilaporan.php?mLapo=efakturexcel&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&msalesid="+msalesid+"&mgrpid="+mgrpid)
			}
	}
    </script>
    <script type="text/javascript">
...
?>	
	...
	<div style="position:relative; width:100%;text-align:left;background-color:sBlue">
	<table width='100%' border="0">
	<tr>
		<td>Tgl. </td> 
		<td><input type=text id=mtgl1 size=10 readonly> S.d. 
		<input type=text id=mtgl2 size=10 readonly></td>
		<td align="center"><a href="" id='goprint' > 
	...
	<tr>
		<td>pelanggan </td> <td colspan="2"><input type=text id=mlgnid size=8><input type='button' id=mllgn value='F5'><input type=text id=mlgnnama readonly> 
		Sales <input type=text id=msalesid size=8><input type='button' id=mlsales value='F5'><input type=text id=msalesnama readonly> 
	<font face='Arial' color='white' >&nbsp;Group Stok 
		<input type=text id=mgrpid size=8>
		<input type='button' id=mgrp value='F5'>
		<input type=text id=mgrpnama readonly></td>
	</tr>	
