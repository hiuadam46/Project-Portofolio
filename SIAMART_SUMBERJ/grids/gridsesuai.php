...
echo ("
<tr id='bodiv_01212' style='text-align:center'>
<td bgcolor=lightblue align=center><b>No.</b></td>
<td bgcolor=lightblue align=center><b>Kode [F5]</b></td>
<td bgcolor=lightblue align=center><b>Nama Stok</b></td>
<td bgcolor=lightblue align=center><b>Qty.</b></td>
<td bgcolor=lightblue align=center><b>Sat.</b></td>
<td bgcolor=lightblue align=center><b>Qty. Aktual</b></td>
<td bgcolor=lightblue align=center><b>Unit</b></td>
<td bgcolor=lightblue align=center><b>Sat.</b></td>
<td bgcolor=lightblue align=center><b>Unit Aktual</b></td>
...
console.log(isphone());
if(isphone() == false){
	document.getElementById('bodiv_01212').hidden = true;
}
if(isphone() == true){
	document.getElementById('backtabel').hidden = true;
}
console.log(document.getElementById('bodiv_01212').hidden);
</script>
");
	...
	while ($rows=mysql_fetch_assoc($rrw))
	{
		...
		echo "
		<tr id='bodiv_$mnom' $mhii>
		<td bgcolor=lightblue align=right><input type='text_$mnom' id='1_$mnom' name='1_$mnom' class='rcell' size=5 value='".$mnom.".' readonly $msty2></td>
