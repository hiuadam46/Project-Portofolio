    ...
    <script type="text/javascript">
	  ...
	  var dialogisopen=false;
		...
		if(isphone() != true){
			...
			document.getElementById('tableconf').style = 'width:100%; margin-top:50px'
			document.getElementById('mket').size = 20
			document.getElementById('mket2').size = 20
...
?>
	...
	<table id='tableconf' style='width:110%'>

	<tr>
		<td>Tgl.</td>
		<td> : <input type=text id=mtgl size=8 readonly></td>
		<td>Lokasi Stok </td>
		<td> :
		<?php
		...
		<td>Keterangan</td><td> :<input type=editbox size=40 id=mket></td>
	
	</tr>

	<tr>
		<td>No.</td><td> : <input type=text id=mnid size=8> </input><input type=button id=lookmnid value='F5'> </td>

		<td> </td>
		<td> </td>
		<td></td>

		<td> :<input type=editbox size=40 id=mket2></td>
