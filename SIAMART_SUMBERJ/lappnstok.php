...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mpnstok&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mstoid="+mstoid+"&mlokid="+mlokid);
		}
		else
		{
			window.open("isilaporan.php?mLapo=mpnstok&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mstoid="+mstoid+"&lokid="+mlokid);
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mpnstok&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mstoid="+mstoid+"&lokid="+mlokid);
	}
}
</script>
<script type="text/javascript">
