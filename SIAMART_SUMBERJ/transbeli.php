	...
	//////////////////////////////create number////////////////////
		...
		for (gg=1;gg<100;gg++)
		{
			...
			if(mstoid != ''){
				...
				list_id_total = list_id_total+String(list_id)
		...
		if (confirm(text) == true) {
			console.log(list_id_total);
			openprintlbl(list_id_total);
		}
	})

	function openprintlbl(id)
	{
		mswi="setprintbarcode.php?id1="+String(id)
		window.open(mswi)
	}
