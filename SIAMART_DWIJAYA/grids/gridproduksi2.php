...
echo("<th rowspan=1> Kode [F5]</th>");$mwd2='8';
echo("<th rowspan=1> Uraian </th>");$mwd3='30 disabled';
echo("<th rowspan=1> Sat. </th>");$mwd4='4 disabled';
echo("<th rowspan=1> Qty </th>");$mwd5='8';
echo("<th rowspan=1> LOT </th>");$mwd6='10';
echo("</tr>");
echo("
<tr>
...
$query="select a.bpid stoid,b.stonama,b.satuan1,FORMAT(a.qtyin,2) qtyin,nid2 
from bkbesar a left join setstok b on a.bpid=b.stoid and a.trans='TRANSPRODUKSI'
where a.qtyin<>0 and a.nid='$mnid' and rekid='10310'
order by a.bpid";
...
while ($rows=mysql_fetch_assoc($rrw))
	...
	<div id='divsum' style='height:59px;overflow:hidden;border-color:black;border-style:solid;border-width:1px;bgcolor:white'>
	<input type=text size=5 id='tabjumlah' hidden value='$mjum' disabled style='text-align:center'>
	<table border=1 cellpadding=0 cellspacing=0 style='border-collapse:collapse'>

	<tr>
	<td  bgcolor='white' colspan=4 align=right>Total Hasil&nbsp;&nbsp;</td>
	<td  bgcolor='white'><input size=$mwd5 type='text'  $nstt2 readonly id='mtotal2'></td>
	</tr>

	<tr>
	<td  bgcolor='white' colspan=4 align=right>Total Bahan&nbsp;&nbsp;</td>
	<td  bgcolor='white'><input size=$mwd5 type='text'  $nstt2 readonly id='mtot1'></td>
	</tr>

	<tr>
	<td  bgcolor='white' colspan=4 align=right>Susut&nbsp;&nbsp;</td>
	<td  bgcolor='white'><input size=$mwd5 type='text'  $nstt2 readonly id='mselisih'></td>
	</tr>
