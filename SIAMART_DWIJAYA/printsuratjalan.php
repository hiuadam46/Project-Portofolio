...
<div>
	<table cellpadding="0" cellspacing="0" style="width: 100%">
		...
		<tr>
			...
			<label id="Label1" style="font-weight: bold" >DWI JAYA SENTOSA</label></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="5"><label id="Label2" style=>Jln Raya No 312 C Babat Lamongan</label></td>
			<td>&nbsp;</td>
		...
		<tr>
			<td colspan="5"><label id="Label3" style="display: none">Telp 0813.5741.8787</label></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>Telp.</td>
	...
	<table cellpadding="0" cellspacing="0" style="width: 100%;height:103mm">
		<thead>
			<tr style="border-style: solid; border-width: 1px">
				...
				<th style="<?php echo borders(1,1,1,1,2) ?>">V</th>
				<th style="display:none;<?php echo borders(1,0,1,1,2) ?>" colspan="2">HARGA</th>
				<th style="display:none;<?php echo borders(1,1,1,1,2) ?>">SUB TOTAL</th>
			</tr>
		</thead>
<?php
/* $query117=executerow('
...
?>
		<tr>
			...
			<td style="text-align: right;display:none"><?php echo $jmlhrg; ?>&nbsp;</td>
		</tr>
<?php
...
?>
		<tfoot>
			<tr>
				...
				<td style="<?php echo borders(0,0,1,0,2) ?>">&nbsp;</td>
				<td style="<?php echo borders(0,0,1,0,2) ?>">&nbsp;</td>
				<td colspan="6" style="font-weight: bold; text-align: right; <?php echo borders(0,0,1,0,2) ?>">
				&nbsp;</td>
				<td colspan="2" style="font-weight: bold; text-align: right;display:none; <?php echo borders(0,1,1,0,2) ?>">
