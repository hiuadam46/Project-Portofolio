	...
	<div style="color: black; font-family: Arial">
		<table width="100%">
			<tr>
				...
				<input id="mtgl2" readonly size="10" type="text"> Stok :
				<input id="mstoid" size="8" type="text"><input id="mlookstok" type="button" value="F5"><input id="mstonama" readonly type="text"> 
				Lokasi : <?php
