...
function buatlaporan(ngeprint)
{
	...
	if (!ngeprint)
	{
		$Pcs2("#framelap").attr("src", "isilaporan.php?mLapo=mlapjualnota&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mkarid="+sal+"&mstoid="+$Pcs2("#mstoid").val())
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapjualnota&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mkarid="+sal+"&mstoid="+$Pcs2("#mstoid").val())
	}
}
</script>
<script type="text/javascript">
...
<form id="fform" name="fform">
	<div style="position: relative; width: 100%; text-align: left; font-family: Arial">
		<table width="100%">
			...
			<tr>
				<td colspan="2" style="color: white">Pelanggan :
