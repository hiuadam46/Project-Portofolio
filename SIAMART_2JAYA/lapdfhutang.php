...
$sqlstr="
select a.bpid,b.supnama,sum(a.kredit-a.debet) saldo from 
bkbesar a left join setsup b on a.bpid=b.supid 
where a.rekid='20010'
group by a.bpid,b.supid order by a.bpid
";
$result = mysql_query ($sqlstr) or die ("Kesalahan pada perintah SQL JUAL1!");
mysql_close($link);
echo("
<br><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;Laporan Daftar Hutang<br><br>
