...
<div id="mmnu" style="text-align: right">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			<span style="width: 40%; color: white; font-family: Verdana; font-size: 14pt; text-decoration: underline; font-weight: bold">
			TB. DUA JAYA</span><br>
			<span id="subtitle" style="color: white; font-family: Verdana">Jl Sunandar 
			Priyo Sudarmo 8 Sidoarjo</span></td>
			<td valign="top">
...
('LAPORAN','topmenu','Laporan','','','','1','1'),
	...
	('LAPJUALNOTA2','','Laporan Penjualan Per Nota','lapjualnota2.php','','LAPORAN','1','1'),
...
while ($roow=mysql_fetch_assoc($mrs))
{
	...
	{
		$query185=executerow("select count(*) cnt from setmenu where menuinduk='$roow2[menuid]' and aktif=1 and menuid in (select menuid from menuuser where user='".$_SESSION['MASUK']."') order by ids,menuid");
		$mjj=mysql_fetch_assoc ($query185);
...
-->
				<li class="toplast">
				<a href="#" style="height: 19px; line-height: 19px;">
				<span style="color: red">Keluar</span></a></li>
			</ul>
			</td>
		</tr>
	</table>
