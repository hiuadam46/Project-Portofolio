<?php
require("../utama.php");
execute("delete from transbeli2 where nid=''");
...
$query="
select a.stoid, FORMAT(a.qty, 0) qty, FORMAT(a.unit, 0) unit, FORMAT(a.extra, 0) extra, FORMAT(a.extraunit, 0) extraunit, FORMAT(hrgsat, 0) hrgsat, FORMAT(diskonp, 2) diskon, FORMAT(diskonp2, 2) diskon2, FORMAT(diskonp3, 2) diskon3, FORMAT(diskonp4, 2) diskon4, FORMAT(jmlhrg, 0) jmlhrg
from transbeli2 a
where a.nid='$mnid'
order by nomor
";
...
while ($rows=mysql_fetch_assoc($rrw))
{
	...
	$mtoid=$rows[stoid];
	$query148=executerow("select stonama,satuan1,satuan2,isi from setstok where stoid='$mtoid'");
	$nng=mysql_fetch_assoc ($query148);
	...
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd4 value='".$rows[qty]."' $nstt2 ></td>
	";
	...
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd6 value='".$rows[unit]."' $nstt2 ></td>
	";
	...
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd8 value='".$rows[extra]."' $nstt2 ></td>
	";
	...
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd10 value='".$rows[extraunit]."' $nstt2 ></td>
	";
	...
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd13 value='".$rows[diskon]."' $nstt2 ></td>
	";

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd13 value='".$rows[diskon2]."' $nstt2 ></td>
	";

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd13 value='".$rows[diskon3]."' $nstt2 ></td>
	";

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd13 value='".$rows[diskon4]."' $nstt2 ></td>
	";

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd14 value='".$rows[jmlhrg]."' $nstt2 ><input type=hidden id='misi_$mnom' name='misi_$mnom' value='$nng[isi]'></td>
	";

	$mjrow=$mjrow+1;
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo '
			<td><input type="button" '.$midname.' value="Stok" onclick=bukastok(this) readonly></td>
	';
...
for ($mgg=$mnom;$mgg<100;$mgg++)
{
	...
	$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
	echo "
			<td><input type='text' $midname size=$mwd14 value='".$rows[jmlhrg]."' $nstt2 ><input type=hidden id='misi_$mnom' name='misi_$mnom'></td>
	";
...
<input type=text size=5 id='tabjumlah' hidden value='$mjum' readonly style='text-align:center'>
	<table border=1 cellpadding=0 cellspacing=0 style='border-collapse:collapse'>
		<tr>
			<td bgcolor='white' rowspan=5 colspan=13 align=center>&nbsp;<font color=red><span id='spanket'></span></td>
			<td bgcolor='white' colspan=3 align=right>Total&nbsp;&nbsp;</td>
			<td bgcolor='white'><input size=$mwd14 type='text' $nstt2 readonly id='mtotal'></td>
		</tr>

		<tr>
			<td bgcolor='white' colspan=3 align=right>Ongkos&nbsp;&nbsp;</td>
			<td bgcolor='white'><input size=$mwd14 type='text' $nstt2 id='mongkos'></td>
		</tr>

		<tr>
			<td bgcolor='white' colspan=3 align=right><input type=checkbox id='mctunai' onclick=rumus1()> Tunai&nbsp;&nbsp;</td>
			<td bgcolor='white'><input size=$mwd14 type='text' $nstt2 id='mtunai'></td>
		</tr>

		<tr>
			<td bgcolor='white' colspan=3 align=right>Hutang&nbsp;&nbsp;</td>
			<td bgcolor='white'><input size=$mwd14 type='text' $nstt2 readonly id='mhutang'></td>
		</tr>

		<tr>
			<td bgcolor='white' colspan=3 align=right>Jt. Tempo&nbsp;&nbsp;</td>
			<td bgcolor='white'><input size=$mwd14 type='text' $nstt2 disabled id='mjt'></td>
		</tr>
		...
		<tr>
			...
			<td bgcolor='white'><input size=$mwd8 type='text' $msty disabled></td>
			<td bgcolor='white'><input size=$mwd9 type='text' $msty disabled></td>
			<td bgcolor='white'><input size=$mwd10 type='text' $msty disabled></td>
			<td bgcolor='white'><input size=$mwd11 type='text' $msty disabled></td>
