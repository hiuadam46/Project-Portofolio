...
$Pcs2(document).ready(function()
{
	...
	execajaxas("alter table transbeli2 add diskonp2 numeric default '0' ")
	execajaxas("alter table transbeli2 add diskonp3 numeric default '0' ")
	execajaxas("alter table transbeli2 add diskonp4 numeric default '0' ")
	execajaxas("ALTER TABLE `transbeli2` CHANGE `diskonp` `diskonp` DOUBLE( 10, 2 ) NOT NULL DEFAULT '0.00'")
	execajaxas("ALTER TABLE `transbeli2` CHANGE `diskonp2` `diskonp2` DOUBLE( 10, 2 ) NOT NULL DEFAULT '0.00'")
	execajaxas("ALTER TABLE `transbeli2` CHANGE `diskonp3` `diskonp3` DOUBLE( 10, 2 ) NOT NULL DEFAULT '0.00'")
	execajaxas("ALTER TABLE `transbeli2` CHANGE `diskonp4` `diskonp4` DOUBLE( 10, 2 ) NOT NULL DEFAULT '0.00'")
	baru()
	...
	$Pcs2("#btnsimpan").click(function()
	{
		...
		mtot=0
		mkat=" insert into transbeli2(nomor,nid,tgl,stoid,qty,unit,extra,extraunit,totqty,hrgsat,jmlhrg,isi,diskonp,diskonp2,diskonp3,diskonp4) values "
		...
		for (gg=1;gg<100;gg++)
		{
			...
			mdisk2=toval($Pcs2("#24_"+gg).val())
			mdisk3=toval($Pcs2("#25_"+gg).val())
			mdisk4=toval($Pcs2("#26_"+gg).val())
			mjmlhrg=toval($Pcs2("#27_"+gg).val())
			...
			if (mstoid!='')
			{
				...
				mkat=mkat+" ('"+gg+"','"+mnid+"',"+mtgl+",'"+mstoid+"','"+mqty+"','"+munit+"','"+mextra+"','"+mextraunit+"','"+mtotqty+"','"+mhrgsat+"','"+mjmlhrg+"','"+misi+"','"+mdisk+"','"+mdisk2+"','"+mdisk3+"','"+mdisk4+"'), "
...
{
	//alert(theid.id);
	mkolom=theid.id.split("_")[0];
	//alert(mkolom);
	if(mkolom=='28')
	{
		mid=theid.id.replace('28','12');
	}
	else
	{
...
function rumus1()
{
	...
	for (gg=1;gg<100;gg++)
	{
		if ($Pcs2("#12_"+gg).val()!='')
		{
			...
			mdis2=mhrg*toval($Pcs2("#24_"+gg).val())*0.01
			mhrg=(mhrg-mdis2)

			mdis3=mhrg*toval($Pcs2("#25_"+gg).val())*0.01
			mhrg=(mhrg-mdis3)

			mdis4=mhrg*toval($Pcs2("#26_"+gg).val())*0.01
			mhrg=(mhrg-mdis4)
			...
			$Pcs2("#27_"+gg).val(tra(mjmlhrg))

			mnii=$Pcs2("#27_"+gg).val()
			mj1=mj1+toval(mnii)
...
<form id="fform" name="fform">
	<table border="0" style="color: white; font-family: Arial; font-weight: bold" width="100%">
		...
		<tr>
			<td>Nota </td>
			<td>: <input id="mfakturid" size="10" type="text"></td>
			<td>Suplier </td>
