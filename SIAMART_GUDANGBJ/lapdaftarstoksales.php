...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel){
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mdfss&mtg1="+mtgl1+"&mtg2="+mtgl2+"&msupid="+msupid+"&mgrpid="+mgrpid+"&mlokid="+mlokid+"&msaldo="+msaldo)
		}
		else
		{
			window.open("isilaporan.php?mLapo=mdfss&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY&msupid="+msupid+"&mgrpid="+mgrpid+"&mlokid="+mlokid+"&msaldo="+msaldo)
		}
	}
	else{
		window.open("isilaporan.php?mLapo=mdfss&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY&msupid="+msupid+"&mgrpid="+mgrpid+"&mlokid="+mlokid+"&msaldo="+msaldo)
	}
}
</script>
<script type="text/javascript">
	...
	<div style="color: white; font-family: Arial">
		<table id="tabelhead" width="100%">
			<tr>
				...
				<input id="msupid" size="5" type="text"><input id="lookmsupid" onclick="bukasuplier()" type="button" value="F5"><input id="msupnama" disabled size="25" type="text">&nbsp;&nbsp; 
				Grup <input id="mgrpid" size="5" type="text"><input id="lookgrpid" onclick="bukagrup()" type="button" value="F5"><input id="mgrpnama" disabled size="25" type="text">
<?php
echo "&nbsp;&nbsp;Lokasi";
