...
function buatnota()
{
	...
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'PELANGI MART'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Jl Ry Sumbermanjing Kulon 73 Malang'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'HP. 085234749975, 085646731936'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'========================================'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>No.'+abc.$Pcs2("#mnid").val()+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tgl. '+abc.$Pcs2("#mtgl").val()+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>Pel.&nbsp; :&nbsp;'+abc.$Pcs2("#mlgnnama").val()+'&nbsp;&nbsp;&nbsp;&nbsp; Jam &nbsp;:&nbsp;'+abc.$Pcs2("#mjam").val()+'</td></tr>'
