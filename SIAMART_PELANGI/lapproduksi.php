...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilapproduksi.php?mLapo=mlapproduksi&mtg1="+mtgl1+"&mtg2="+mtgl2+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
		}
		else
		{
			window.open("isilapproduksi.php?mLapo=mlapproduksi&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
		}
	}
	else
	{
		window.open("isilapproduksi.php?mLapo=mlapproduksi&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
	}
}
</script>
<script type="text/javascript">
