...
<title>Penjualan per Kasir</title>
...
{
	$Pcs2("#mtgl1").val(tglsekarang());
	$Pcs2("#mtgl2").val(tglsekarang());
	buatlaporan();
...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapkasirperkasir&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mkasir="+$Pcs2("#mkasir").val()+"&mtk="+mtk+"&mur="+mur+"&mgrpid="+mgrpid+"&msupid="+msupid)
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapkasirperkasir&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mkasir="+$Pcs2("#mkasir").val()+"&mtk="+mtk+"&mur="+mur+"&mgrpid="+mgrpid+"&msupid="+msupid)
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapkasirperkasir&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mkasir="+$Pcs2("#mkasir").val()+"&mtk="+mtk+"&mur="+mur+"&mgrpid="+mgrpid+"&msupid="+msupid)
	}
