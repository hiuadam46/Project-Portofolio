...
?>	
	...
	<tr>
		<td>Kasir :&nbsp;&nbsp;&nbsp;&emsp;&emsp;
			<input type=text id=mkasir size=8>
			<input type='button' id=mlkasir value='F5'>
			<input type=text id=mkasirnama readonly>
		</tr>
		<tr>
			<td>
			Grup Stok :&nbsp;&nbsp;&nbsp;
	...
	<tr>
		<td>
			Suplier : &emsp;&emsp;<input type=text id=msupid size=8>
			<input type='button' id=mlsup value='F5'>
			<input type=text id=msupnama readonly>
