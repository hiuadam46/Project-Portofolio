...
/*	
$ada=execute(" SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE table_schema='siamart_timur_data' and TABLE_NAME = 'setsup' AND COLUMN_NAME = 'isppn' ")->column_name;
...
?>	
	...
	FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='siamart_timur_data' and TABLE_NAME='setsup' 
