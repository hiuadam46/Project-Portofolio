...
function buatlaporan(ngeprint, excel)
{
	...
	if(!excel)
	{
		if (!ngeprint)
		{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapbelinota&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mppn="+mppn+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
		}
		else
		{
			window.open("isilaporan.php?mLapo=mlapbelinota&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mppn="+mppn+"&isprint=YY"+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
		}
	}
	else
	{
		window.open("isilaporan.php?mLapo=mlapbelinota&excel=true&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mppn="+mppn+"&isprint=YY"+"&msupid="+asd+"&mstoid="+$Pcs2("#mstoid").val());
	}
}
</script>
<script type="text/javascript">
	...
	<div>
		<table style="position: relative; text-align: left; color: white; font-family: Arial" width="100%">
			...
			<tr>
				...
				<!-- <input type=text id=mstonama readonly> -->Jenis Barang :
