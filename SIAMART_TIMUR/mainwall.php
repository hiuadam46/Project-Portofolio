...
mysql_select_db('siamart_timur_data',$linksa);
...
if ($mkomn=='kasir2-PC')
{
	...
	FROM information_schema.TABLES WHERE TABLE_SCHEMA='siamart_timur_data'
	";
...
/*
execute("ALTER TABLE siamart_timur_data.setstok DROP INDEX setstok1 , ADD INDEX setstok1 (stoid)");
execute("ALTER TABLE siamart_timur_data.setstok DROP INDEX setstok2 , ADD FULLTEXT setstok2 (stonama)");
execute("ALTER TABLE siamart_timur_data.setstok DROP INDEX setstok3 , ADD INDEX setstok3 (barcode)");
execute("ALTER TABLE siamart_timur_data.setstok DROP INDEX setstok4 , ADD INDEX setstok4 (grpid)");
execute("ALTER TABLE siamart_timur_data.setstok DROP INDEX setstok5 , ADD INDEX setstok5 (supid)");

execute("ALTER TABLE siamart_timur_data.bkbesar DROP INDEX bkbesar1,ADD INDEX bkbesar1 ( tgl, rekid , bpid , nid ) ");

execute("ALTER TABLE siamart_timur_data.transkasir1 DROP INDEX transkasir1 ,ADD INDEX transkasir1 ( tgl,nid ) ");
execute("ALTER TABLE siamart_timur_data.transkasir2 DROP INDEX transkasir2 ,ADD INDEX transkasir2 ( tgl,nid ) ");

execute("ALTER TABLE siamart_timur_data.transbeli1 DROP INDEX transbeli1 ,ADD INDEX transbeli1 ( tgl,nid ) ");
execute("ALTER TABLE siamart_timur_data.transbeli2 DROP INDEX transbeli2 ,ADD INDEX transbeli2 ( tgl,nid ) ");
*/
