...
$Pcs2(document).ready(function()
{
	...
	$Pcs2("#fform").keydown(function()
	{
		...
		if (mmv==116 && (mmid.substr(0,2)=='12' || mmid.substr(0,2)=='32') )
		{
			...
			{
				query1="select left(a.stoid, 10) K, left(a.barcode, 12) Barc, left(a.stonama, 46) Nama, left(format(a.hrgjual"+mha+"/if("+msatuan+"=1, 1, isi), 0), 12) rightHarga from setstok a "
				query2=" where true "
			}
			query1="select left(a.stoid, 10) K, left(a.barcode, 12) Barc, left(a.stonama, 46) Nama, left(format(a.hrgjual"+mha+"/if("+msatuan+"=1, 1, isi), 0), 12) rightHarga, 'L001' QSALDO, stoid from setstok a "
			query2=" where true "
...
function baru(mgdn)
{
	...
	$Pcs2("#lblwalk").html("TOKO TIMUR Siap Melayani Anda")
...
<form id="fform" name="fform">
	<table border="0" style="border-collapse: ; color: white; font-family: Arial; font-weight: bold" width="100%">
		...
		<tr>
			...
			<label id="lblwalk" style="font-size: 18pt">TOKO TIMUR 
