...
function buatnota()
{
	...
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'TOKO TIMUR'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Jl Bromo 1 Wlingi Blitar'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2 align=center>'+'Telp. 0342-691055'+'</td></tr>'
	mjadd=mjadd+'<tr height=0><td colspan=2>'+'========================================'+'</td></tr>'
