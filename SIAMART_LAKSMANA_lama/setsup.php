...
?>	
	...
	FROM information_schema.COLUMNS WHERE TABLE_SCHEMA='siamart_laksmana_data' and TABLE_NAME='setsup' 
	and COLUMN_COMMENT<>'' and COLUMN_NAME in ('supid','supnama','alamat','telp','kontak','tempo','norek','keterangan') 
