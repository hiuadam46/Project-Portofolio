...
<html><head>
	...
	function buatlaporan(ngeprint)
	{
			...
			if (!ngeprint)
			{
			$Pcs2("#framelap").attr("src","isilaporan.php?mLapo=mlapjualnota&mtg1="+mtgl1+"&mtg2="+mtgl2+"&mlgnid="+asd+"&mtk="+sal+"&mstoid="+$Pcs2("#mstoid").val())
			}
			else
			{
			window.open("isilaporan.php?mLapo=mlapjualnota&mtg1="+mtgl1+"&mtg2="+mtgl2+"&isprint=YY"+"&mlgnid="+asd+"&mtk="+sal+"&mstoid="+$Pcs2("#mstoid").val())
			}
...
?>	
   ...
   Jenis : <select id='mtk'> <option value='Kredit'>Kredit</option> <option value='Tunai'>Tunai</option> <option value='Semua'>Semua</option> </select>  
