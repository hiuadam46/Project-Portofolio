...
<div id="mmnu" style="text-align: right">
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr>
			...
			TOKO LAKSMANA JAYA</label></b><br>
			<label style="color: white; font-family: Verdana">
			<span id="subtitle">Jl.Raya Pasar Ngentak Gandusari</span></label></td>
			<td valign="top">
...
while ($roow=mysql_fetch_assoc($mrs))
{
	...
	{
		$mjj_182=executerow("select count(*) cnt from setmenu where menuinduk='$roow2[menuid]' and aktif=1 and menuid in (select menuid from menuuser where user='".$_SESSION['MASUK']."') order by ids,menuid");
		
		$mjj=mysql_fetch_assoc($mjj_182);
