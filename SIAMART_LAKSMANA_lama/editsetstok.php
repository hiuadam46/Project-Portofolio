...
');
$mstok=mysql_fetch_assoc($mstok_13);
...
<form id="fform">
	...
	<table border="0" style="border-color: aqua" width="100%">
		<tr>
			...
			Isi :
			<input id="misi" name="misi" size="5" style="max-width: 50px" value="<?php echo $mstok[isi] ?>"><input id="msatuan2" disabled name="msatuan2" size="5" type="text" value="<?php echo $mstok[satuan2] ?>"></td>
		</tr>
		<tr>
		...
		<tr>
			<td align="left">Hrg. Jual Khusus </td>
			<td>:
		...
		<tr>
			<td align="left">Nominal Poin</td>
			<td align="left" class="hju">:
			<input id="mnp" name="mnp" size="10" style="text-align: right" type="text" value="<?php echo number_format($mstok[jmlhrg],0,'.',',') ?>"></td>
		</tr>
		<tr hidden>
			<td align="left">Print Stok</td>
			<td align="left" class="hju">:
			<input id="print" name="print" size="10" style="text-align: right" type="text" value="<?php echo $mstok['print'] ?>"></td>
		</tr>
	</table>
	<hr><label style="font-family: Verdana; color: white; font-size: 14pt">
	<input id="bsimpan" type="button" value="<?php echo $meed; ?>">
	...
	<div id="kotakdialog2" style="font-family: Verdana; color: white; font-size: 14pt">
		<center>
...
$Pcs2(document).ready(function()
{
	...
	$Pcs2('#bsimpan').click(function()
	{
		...
		if(mvnp<=0)
		{
			alert('Nominal Poin harus lebih besar dari Nol...!');
			$Pcs2('#mnp').focus();
			$Pcs2('#mnp').select();
			return;
		}
