...
require("utama.php");
$abc=execute("select * from transkasir1 a, setlgn b where nid='$mnid' and a.lgnid=b.lgnid");
...
echo '
	<tr height=0>
		<td colspan=6>Jam '.$abc[jam].'</td>
	</tr>
';
echo '
	<tr height=0>
		<td colspan=6>Pel.'.$abc[lgnid].' '.$abc[lgnnama].'</td>
	</tr>
';
echo '
	<tr height=0>
...
echo '
	<tr height=0>
		...
		<td align=right colspan=2>'.$abc[total].'</td>
	</tr>
';
echo '
	<tr height=0>
		<td colspan=4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.'EDC </td>
		<td align=right colspan=2>'.$abc[edc].'</td>
	</tr>
';
echo '
	<tr height=0>
		<td colspan=4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.'BAYAR </td>
		<td align=right colspan=2>'.$abc[bayar].'</td>
	</tr>
';
echo '
	<tr height=0>
		<td colspan=4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.'KEMBALI</td>
		<td align=right colspan=2>'.$abc[kembali].'</td>
	</tr>
';
echo '
	<tr height=0>
		<td colspan=4>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.'SALDO POIN</td>
		<td align=right colspan=2>'.$mtjpoin.'</td>
	</tr>
';
...
echo '
	<tr height=0>
		<td colspan=6 align=center>'.'Kami tunggu kedatangan anda kembali'.'</td>
	</tr>
';
echo '
	<tr height=0>
...
echo '
	<tr height=0>
		<td colspan=6 align=center>'.'TOKO LAKSAMANA JAYA'.'</td>
	</tr>
';
echo '
	<tr height=0>
		<td colspan=6 align=center>'.'Jl Raya Pasar Ngentak Gandusari'.'</td>
	</tr>
';
echo '
	<tr height=0>
		<td colspan=6 align=center>'.'Telp  08125971291, 081252416388'.'</td>
	</tr>
	<tr height=0>
		<td colspan=6 align=center>'.'Telp  081556746930'.'</td>
	</tr>
';
echo '
	<tr height=0>
