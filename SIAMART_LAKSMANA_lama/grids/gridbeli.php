...
<div id='backtabel' style='height:39px;overflow:hidden;background-image: url(images/nums.jpg);border-color:black;border-style:solid;border-width:1px;bgcolor:white'>
	<table border=1 cellpadding=0 cellspacing=0 style='background-image: url(images/nums.jpg);border-collapse:collapse' >
		<tr>");
			...
			$mwd1='2 readonly';
			echo("<th rowspan=2> Kode<br>[F5][F6]</th>");
			$mwd2='8';
			echo("<th rowspan=2> Uraian </th>");
			$mwd3='40 readonly';
			echo("<th colspan=4> Qty Beli </th>");
			$mwd4567='6';
			echo("<th colspan=4> Extra </th>");
			$mwd891011='6';
			echo("<th rowspan=2> Harga </th>");
			$mwd12='6';
			/* echo("<th rowspan=2> Dis<br>% </th>");$mwd13='3'; */
			echo("<th rowspan=2> Dis<br>Rp. </th>");
			$mwd13='6';
...
<div id='backtabel' style='background-image: url(images/backt.png);height:300px;border-color:black;border-style:solid;border-width:1px;overflow-y:scroll'>
	...
	$query="
	select a.stoid, FORMAT(a.qty,0) qty, FORMAT(a.unit,0) unit, FORMAT(a.extra,0) extra, FORMAT(a.extraunit,0) extraunit, FORMAT(hrgsat,0) hrgsat, FORMAT(diskonrp,0) diskon, FORMAT(jmlhrg,0) jmlhrg
	from transbeli2 a
	where a.nid='$mnid'
	order by nomor
	";
	...
	while ($rows=mysql_fetch_assoc($rrw))
	{
		...
		$midname="id='$mjrow".'_'."$mnom' name='$mjrow".'_'."$mnom'";
			...
			$mjrow=$mjrow+1;
			$midname="id='23".'_'."$mnom' name='$mjrow".'_'."$mnom'";
			echo "
...
<input type=text size=5 id='tabjumlah' hidden value='$mjum' readonly style='text-align:center'>
	<table border=1 cellpadding=0 cellspacing=0 style='border-collapse:collapse'>
		...
		<tr>
			...
			<td bgcolor='white'><input size=8 type='text' $nstt2 id='mongkos'></td>
		</tr>
		
		<tr>
			<td bgcolor='white' colspan=2 align=right><input type=checkbox id='mctunai' onclick=rumus1()> Tunai&nbsp;&nbsp;</td>
			<td bgcolor='white'><input size=8 type='text' $nstt2 id='mtunai'></td>
		</tr>
		
		<tr>
			<td bgcolor='white' colspan=2 align=right>Hutang&nbsp;&nbsp;</td>
