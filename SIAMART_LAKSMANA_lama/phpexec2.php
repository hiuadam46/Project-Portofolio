...
if($mTransaksixx=='fsstx001')
{
	...
	insert into setstok
	(
		stoid, barcode, barcode2, stonama, grpid, supid, satuan, satuan1, satuan2, hrgbeli, hrgjual, hrgjual2, hrgjual3, hrgjual4, jmlhrg, minimal, isi, isi2, aktif, print
	)
	values
	(
		"'.$mstoid.'", "'.$mbarcode.'", "'.$mbarcode2.'", "'.$mstonama.'", "'.$mgrpid.'", "'.$msupid.'", "'.$msatid.'", "'.$msatuan1.'", "'.$msatuan2.'", "'.$mhrgbeli.'", "'.$mhrgjual.'", "'.$mhrgjual2.'", "'.$mhrgjual3.'", "'.$mhrgjual4.'", "'.$mnp.'", "'.$mminimal.'", "'.$misi.'", "'.$misi2.'", 1, "'.$print.'"
	)
	';
