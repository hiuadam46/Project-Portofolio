...
$def=executerow("select a.*,b.stonama from transkasir2 a left join setstok b on a.stoid=b.stoid where nid='$mnid' and b.print=1 and a.satuan=b.satuan1 order by a.num");
